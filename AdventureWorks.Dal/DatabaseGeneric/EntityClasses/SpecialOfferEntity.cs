...
namespace AdventureWorks.Dal.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private EntityCollection<ProductEntity> _productCollectionViaSpecialOfferProduct;
		...
		protected SpecialOfferEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_productCollectionViaSpecialOfferProduct = (EntityCollection<ProductEntity>)info.GetValue("_productCollectionViaSpecialOfferProduct", typeof(EntityCollection<ProductEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "ProductCollectionViaSpecialOfferProduct":
					this.ProductCollectionViaSpecialOfferProduct.IsReadOnly = false;
					this.ProductCollectionViaSpecialOfferProduct.Add((ProductEntity)entity);
					this.ProductCollectionViaSpecialOfferProduct.IsReadOnly = true;
					break;
				default:
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				info.AddValue("_productCollectionViaSpecialOfferProduct", ((_productCollectionViaSpecialOfferProduct!=null) && (_productCollectionViaSpecialOfferProduct.Count>0) && !this.MarkedForDeletion)?_productCollectionViaSpecialOfferProduct:null);
			}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoProductCollectionViaSpecialOfferProduct()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("ProductCollectionViaSpecialOfferProduct"));
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(SpecialOfferFields.SpecialOfferId, null, ComparisonOperator.Equal, this.SpecialOfferId, "SpecialOfferEntity__"));
			return bucket;
		}
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._productCollectionViaSpecialOfferProduct);
		}
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._productCollectionViaSpecialOfferProduct = (EntityCollection<ProductEntity>) collectionsQueue.Dequeue();
		...
		protected override bool HasPopulatedMemberEntityCollections()
		{
			...
			toReturn |= (this._productCollectionViaSpecialOfferProduct != null);
		...
		public static IPrefetchPathElement2 PrefetchPathProductCollectionViaSpecialOfferProduct
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ProductEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))), intermediateRelation,
					(int)AdventureWorks.Dal.EntityType.SpecialOfferEntity, (int)AdventureWorks.Dal.EntityType.ProductEntity, 0, null, null, GetRelationsForField("ProductCollectionViaSpecialOfferProduct"), null, "ProductCollectionViaSpecialOfferProduct", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public virtual EntityCollection<ProductEntity> ProductCollectionViaSpecialOfferProduct
		{
			get { return GetOrCreateEntityCollection<ProductEntity, ProductEntityFactory>("SpecialOfferCollectionViaSpecialOfferProduct", false, true, ref _productCollectionViaSpecialOfferProduct);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.SpecialOfferEntity; }
		}
