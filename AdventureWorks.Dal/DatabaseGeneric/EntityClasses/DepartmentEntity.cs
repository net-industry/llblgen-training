...
namespace AdventureWorks.Dal.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private EntityCollection<EmployeeEntity> _employeeCollectionViaEmployeeDepartmentHistory;
		...
		protected DepartmentEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_employeeCollectionViaEmployeeDepartmentHistory = (EntityCollection<EmployeeEntity>)info.GetValue("_employeeCollectionViaEmployeeDepartmentHistory", typeof(EntityCollection<EmployeeEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "EmployeeCollectionViaEmployeeDepartmentHistory":
					this.EmployeeCollectionViaEmployeeDepartmentHistory.IsReadOnly = false;
					this.EmployeeCollectionViaEmployeeDepartmentHistory.Add((EmployeeEntity)entity);
					this.EmployeeCollectionViaEmployeeDepartmentHistory.IsReadOnly = true;
					break;
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				case "EmployeeDepartmentHistories":
					...
					break;
				case "EmployeeCollectionViaEmployeeDepartmentHistory":
					toReturn.Add(Relations.EmployeeDepartmentHistoryEntityUsingDepartmentId, "DepartmentEntity__", "EmployeeDepartmentHistory_", JoinHint.None);
					toReturn.Add(EmployeeDepartmentHistoryEntity.Relations.EmployeeEntityUsingBusinessEntityId, "EmployeeDepartmentHistory_", string.Empty, JoinHint.None);
					break;
				case "ShiftCollectionViaEmployeeDepartmentHistory":
					toReturn.Add(Relations.EmployeeDepartmentHistoryEntityUsingDepartmentId, "DepartmentEntity__", "EmployeeDepartmentHistory_", JoinHint.None);
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				info.AddValue("_employeeCollectionViaEmployeeDepartmentHistory", ((_employeeCollectionViaEmployeeDepartmentHistory!=null) && (_employeeCollectionViaEmployeeDepartmentHistory.Count>0) && !this.MarkedForDeletion)?_employeeCollectionViaEmployeeDepartmentHistory:null);
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoEmployeeCollectionViaEmployeeDepartmentHistory()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("EmployeeCollectionViaEmployeeDepartmentHistory"));
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(DepartmentFields.DepartmentId, null, ComparisonOperator.Equal, this.DepartmentId, "DepartmentEntity__"));
			return bucket;
		}
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._employeeCollectionViaEmployeeDepartmentHistory);
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._employeeCollectionViaEmployeeDepartmentHistory = (EntityCollection<EmployeeEntity>) collectionsQueue.Dequeue();
		...
		protected override bool HasPopulatedMemberEntityCollections()
		{
			...
			toReturn |= (this._employeeCollectionViaEmployeeDepartmentHistory != null);
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<EmployeeDepartmentHistoryEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeDepartmentHistoryEntityFactory))), (IEntityRelation)GetRelationsForField("EmployeeDepartmentHistories")[0], (int)AdventureWorks.Dal.EntityType.DepartmentEntity, (int)AdventureWorks.Dal.EntityType.EmployeeDepartmentHistoryEntity, 0, null, null, null, null, "EmployeeDepartmentHistories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathEmployeeCollectionViaEmployeeDepartmentHistory
		{
			get
			{
				IEntityRelation intermediateRelation = Relations.EmployeeDepartmentHistoryEntityUsingDepartmentId;
				...
				return new PrefetchPathElement2(new EntityCollection<EmployeeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))), intermediateRelation,
					(int)AdventureWorks.Dal.EntityType.DepartmentEntity, (int)AdventureWorks.Dal.EntityType.EmployeeEntity, 0, null, null, GetRelationsForField("EmployeeCollectionViaEmployeeDepartmentHistory"), null, "EmployeeCollectionViaEmployeeDepartmentHistory", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathShiftCollectionViaEmployeeDepartmentHistory
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ShiftEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ShiftEntityFactory))), intermediateRelation,
					(int)AdventureWorks.Dal.EntityType.DepartmentEntity, (int)AdventureWorks.Dal.EntityType.ShiftEntity, 0, null, null, GetRelationsForField("ShiftCollectionViaEmployeeDepartmentHistory"), null, "ShiftCollectionViaEmployeeDepartmentHistory", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public virtual EntityCollection<EmployeeEntity> EmployeeCollectionViaEmployeeDepartmentHistory
		{
			get { return GetOrCreateEntityCollection<EmployeeEntity, EmployeeEntityFactory>("DepartmentCollectionViaEmployeeDepartmentHistory", false, true, ref _employeeCollectionViaEmployeeDepartmentHistory);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<ShiftEntity, ShiftEntityFactory>("DepartmentCollectionViaEmployeeDepartmentHistory", false, true, ref _shiftCollectionViaEmployeeDepartmentHistory);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.DepartmentEntity; }
		}
