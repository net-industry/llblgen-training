			...
			
	{
		...
		private void SetupSyncSalesOrderHeader(IEntityCore relatedEntity)
		{
			if(_salesOrderHeader!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _salesOrderHeader, new PropertyChangedEventHandler( OnSalesOrderHeaderPropertyChanged ), "SalesOrderHeader", AdventureWorks.Dal.RelationClasses.StaticSalesOrderHeaderSalesReasonRelations.SalesOrderHeaderEntityUsingSalesOrderIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _salesReason, new PropertyChangedEventHandler( OnSalesReasonPropertyChanged ), "SalesReason", AdventureWorks.Dal.RelationClasses.StaticSalesOrderHeaderSalesReasonRelations.SalesReasonEntityUsingSalesReasonIdStatic, true, signalRelatedEntity, "SalesOrderHeaderSalesReasons", resetFKFields, new int[] { (int)SalesOrderHeaderSalesReasonFieldIndex.SalesReasonId } );
			_salesReason = null;
		}
		...
		private void SetupSyncSalesReason(IEntityCore relatedEntity)
		{
			if(_salesReason!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _salesReason, new PropertyChangedEventHandler( OnSalesReasonPropertyChanged ), "SalesReason", AdventureWorks.Dal.RelationClasses.StaticSalesOrderHeaderSalesReasonRelations.SalesReasonEntityUsingSalesReasonIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SalesReasonEntityFactory))),	(IEntityRelation)GetRelationsForField("SalesReason")[0], (int)AdventureWorks.Dal.EntityType.SalesOrderHeaderSalesReasonEntity, (int)AdventureWorks.Dal.EntityType.SalesReasonEntity, 0, null, null, null, null, "SalesReason", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.SalesOrderHeaderSalesReasonEntity; }
		}
