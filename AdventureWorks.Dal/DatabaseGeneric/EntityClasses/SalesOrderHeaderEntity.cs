...
namespace AdventureWorks.Dal.EntityClasses
{
			...
			
	{
		...
		private EntityCollection<SalesReasonEntity> _salesReasonCollectionViaSalesOrderHeaderSalesReason;
		private EntityCollection<SpecialOfferProductEntity> _specialOfferProductCollectionViaSalesOrderDetail;
		private AddressEntity _address;
		private AddressEntity _address1;
		...
		public static partial class MemberNames
		{
			...
			/// <summary>Member name Address1</summary>
		...
		protected SalesOrderHeaderEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_salesReasonCollectionViaSalesOrderHeaderSalesReason = (EntityCollection<SalesReasonEntity>)info.GetValue("_salesReasonCollectionViaSalesOrderHeaderSalesReason", typeof(EntityCollection<SalesReasonEntity>));
				_specialOfferProductCollectionViaSalesOrderDetail = (EntityCollection<SpecialOfferProductEntity>)info.GetValue("_specialOfferProductCollectionViaSalesOrderDetail", typeof(EntityCollection<SpecialOfferProductEntity>));
				_address = (AddressEntity)info.GetValue("_address", typeof(AddressEntity));
				if(_address!=null)
				{
					_address.AfterSave+=new EventHandler(OnEntityAfterSave);
				}
				_address1 = (AddressEntity)info.GetValue("_address1", typeof(AddressEntity));
				if(_address1!=null)
				{
					_address1.AfterSave+=new EventHandler(OnEntityAfterSave);
				}
		...
		protected override void PerformDesyncSetupFKFieldChange(int fieldIndex)
		{
			switch((SalesOrderHeaderFieldIndex)fieldIndex)
			{
				...
				case SalesOrderHeaderFieldIndex.ShipToAddressId:
					DesetupSyncAddress1(true, false);
					break;
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				case "Address":
					...
					break;
				case "Address1":
					this.Address1 = (AddressEntity)entity;
					break;
				case "ShipMethod":
				...
				case "SalesReasonCollectionViaSalesOrderHeaderSalesReason":
					this.SalesReasonCollectionViaSalesOrderHeaderSalesReason.IsReadOnly = false;
					this.SalesReasonCollectionViaSalesOrderHeaderSalesReason.Add((SalesReasonEntity)entity);
					this.SalesReasonCollectionViaSalesOrderHeaderSalesReason.IsReadOnly = true;
					break;
				case "SpecialOfferProductCollectionViaSalesOrderDetail":
					this.SpecialOfferProductCollectionViaSalesOrderDetail.IsReadOnly = false;
					this.SpecialOfferProductCollectionViaSalesOrderDetail.Add((SpecialOfferProductEntity)entity);
					this.SpecialOfferProductCollectionViaSalesOrderDetail.IsReadOnly = true;
					break;
				default:
		...
		protected override void SetRelatedEntity(IEntityCore relatedEntity, string fieldName)
		{
			switch(fieldName)
			{
				case "Address":
					...
					break;
				case "Address1":
					SetupSyncAddress1(relatedEntity);
					break;
				case "ShipMethod":
		...
		protected override void UnsetRelatedEntity(IEntityCore relatedEntity, string fieldName, bool signalRelatedEntityManyToOne)
		{
			switch(fieldName)
			{
				case "Address":
					...
					break;
				case "Address1":
					DesetupSyncAddress1(false, true);
					break;
				case "ShipMethod":
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				info.AddValue("_salesReasonCollectionViaSalesOrderHeaderSalesReason", ((_salesReasonCollectionViaSalesOrderHeaderSalesReason!=null) && (_salesReasonCollectionViaSalesOrderHeaderSalesReason.Count>0) && !this.MarkedForDeletion)?_salesReasonCollectionViaSalesOrderHeaderSalesReason:null);
				info.AddValue("_specialOfferProductCollectionViaSalesOrderDetail", ((_specialOfferProductCollectionViaSalesOrderDetail!=null) && (_specialOfferProductCollectionViaSalesOrderDetail.Count>0) && !this.MarkedForDeletion)?_specialOfferProductCollectionViaSalesOrderDetail:null);
				info.AddValue("_address", (!this.MarkedForDeletion?_address:null));
				info.AddValue("_address1", (!this.MarkedForDeletion?_address1:null));
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoSalesReasonCollectionViaSalesOrderHeaderSalesReason()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("SalesReasonCollectionViaSalesOrderHeaderSalesReason"));
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(SalesOrderHeaderFields.SalesOrderId, null, ComparisonOperator.Equal, this.SalesOrderId, "SalesOrderHeaderEntity__"));
			return bucket;
		}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoSpecialOfferProductCollectionViaSalesOrderDetail()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("SpecialOfferProductCollectionViaSalesOrderDetail"));
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(SalesOrderHeaderFields.SalesOrderId, null, ComparisonOperator.Equal, this.SalesOrderId, "SalesOrderHeaderEntity__"));
			return bucket;
		}
		...
		/// <summary> Creates a new IRelationPredicateBucket object which contains the predicate expression and relation collection to fetch the related entity of type 'Address' to this entity.</summary>
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoAddress1()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(SalesPersonFields.BusinessEntityId, null, ComparisonOperator.Equal, this.SalesPersonId));
			return bucket;
		}
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._salesReasonCollectionViaSalesOrderHeaderSalesReason);
			collectionsQueue.Enqueue(this._specialOfferProductCollectionViaSalesOrderDetail);
		}
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._salesReasonCollectionViaSalesOrderHeaderSalesReason = (EntityCollection<SalesReasonEntity>) collectionsQueue.Dequeue();
			this._specialOfferProductCollectionViaSalesOrderDetail = (EntityCollection<SpecialOfferProductEntity>) collectionsQueue.Dequeue();
		...
		protected override bool HasPopulatedMemberEntityCollections()
		{
			...
			toReturn |= (this._salesReasonCollectionViaSalesOrderHeaderSalesReason != null);
			toReturn |= (this._specialOfferProductCollectionViaSalesOrderDetail != null);
		...
		protected override void CreateMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue, Queue<bool> requiredQueue) 
		{
			...
			collectionsQueue.Enqueue(requiredQueue.Dequeue() ? new EntityCollection<SalesReasonEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SalesReasonEntityFactory))) : null);
		...
		protected override Dictionary<string, object> GetRelatedData()
		{
			...
			toReturn.Add("Address1", _address1);
		...
		{
			this.PerformDesetupSyncRelatedEntity( _address, new PropertyChangedEventHandler( OnAddressPropertyChanged ), "Address", AdventureWorks.Dal.RelationClasses.StaticSalesOrderHeaderRelations.AddressEntityUsingBillToAddressIdStatic, true, signalRelatedEntity, "SalesOrderHeaders", resetFKFields, new int[] { (int)SalesOrderHeaderFieldIndex.BillToAddressId } );
			_address = null;
		}
		...
		private void SetupSyncAddress(IEntityCore relatedEntity)
		{
			if(_address!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _address, new PropertyChangedEventHandler( OnAddressPropertyChanged ), "Address", AdventureWorks.Dal.RelationClasses.StaticSalesOrderHeaderRelations.AddressEntityUsingBillToAddressIdStatic, true, new string[] {  } );
			}
		}
		...
		/// <summary> Removes the sync logic for member _address1</summary>
		/// <param name="signalRelatedEntity">If set to true, it will call the related entity's UnsetRelatedEntity method</param>
		/// <param name="resetFKFields">if set to true it will also reset the FK fields pointing to the related entity</param>
		private void DesetupSyncAddress1(bool signalRelatedEntity, bool resetFKFields)
		{
			this.PerformDesetupSyncRelatedEntity( _address1, new PropertyChangedEventHandler( OnAddress1PropertyChanged ), "Address1", AdventureWorks.Dal.RelationClasses.StaticSalesOrderHeaderRelations.AddressEntityUsingShipToAddressIdStatic, true, signalRelatedEntity, "SalesOrderHeaders1", resetFKFields, new int[] { (int)SalesOrderHeaderFieldIndex.ShipToAddressId } );
			_address1 = null;
		}

		/// <summary> setups the sync logic for member _address1</summary>
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncAddress1(IEntityCore relatedEntity)
		{
			if(_address1!=relatedEntity)
			{
				DesetupSyncAddress1(true, true);
				_address1 = (AddressEntity)relatedEntity;
				this.PerformSetupSyncRelatedEntity( _address1, new PropertyChangedEventHandler( OnAddress1PropertyChanged ), "Address1", AdventureWorks.Dal.RelationClasses.StaticSalesOrderHeaderRelations.AddressEntityUsingShipToAddressIdStatic, true, new string[] {  } );
			}
		}
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void OnAddress1PropertyChanged( object sender, PropertyChangedEventArgs e )
		{
			switch( e.PropertyName )
			{
				default:
		...
		{
			this.PerformDesetupSyncRelatedEntity( _shipMethod, new PropertyChangedEventHandler( OnShipMethodPropertyChanged ), "ShipMethod", AdventureWorks.Dal.RelationClasses.StaticSalesOrderHeaderRelations.ShipMethodEntityUsingShipMethodIdStatic, true, signalRelatedEntity, "SalesOrderHeaders", resetFKFields, new int[] { (int)SalesOrderHeaderFieldIndex.ShipMethodId } );
			_shipMethod = null;
		}
		...
		private void SetupSyncShipMethod(IEntityCore relatedEntity)
		{
			if(_shipMethod!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _shipMethod, new PropertyChangedEventHandler( OnShipMethodPropertyChanged ), "ShipMethod", AdventureWorks.Dal.RelationClasses.StaticSalesOrderHeaderRelations.ShipMethodEntityUsingShipMethodIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncCreditCard(IEntityCore relatedEntity)
		{
			if(_creditCard!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _creditCard, new PropertyChangedEventHandler( OnCreditCardPropertyChanged ), "CreditCard", AdventureWorks.Dal.RelationClasses.StaticSalesOrderHeaderRelations.CreditCardEntityUsingCreditCardIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncCurrencyRate(IEntityCore relatedEntity)
		{
			if(_currencyRate!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _currencyRate, new PropertyChangedEventHandler( OnCurrencyRatePropertyChanged ), "CurrencyRate", AdventureWorks.Dal.RelationClasses.StaticSalesOrderHeaderRelations.CurrencyRateEntityUsingCurrencyRateIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _customer, new PropertyChangedEventHandler( OnCustomerPropertyChanged ), "Customer", AdventureWorks.Dal.RelationClasses.StaticSalesOrderHeaderRelations.CustomerEntityUsingCustomerIdStatic, true, signalRelatedEntity, "SalesOrderHeaders", resetFKFields, new int[] { (int)SalesOrderHeaderFieldIndex.CustomerId } );
			_customer = null;
		}
		...
		private void SetupSyncCustomer(IEntityCore relatedEntity)
		{
			if(_customer!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _customer, new PropertyChangedEventHandler( OnCustomerPropertyChanged ), "Customer", AdventureWorks.Dal.RelationClasses.StaticSalesOrderHeaderRelations.CustomerEntityUsingCustomerIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncSalesPerson(IEntityCore relatedEntity)
		{
			if(_salesPerson!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _salesPerson, new PropertyChangedEventHandler( OnSalesPersonPropertyChanged ), "SalesPerson", AdventureWorks.Dal.RelationClasses.StaticSalesOrderHeaderRelations.SalesPersonEntityUsingSalesPersonIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncSalesTerritory(IEntityCore relatedEntity)
		{
			if(_salesTerritory!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _salesTerritory, new PropertyChangedEventHandler( OnSalesTerritoryPropertyChanged ), "SalesTerritory", AdventureWorks.Dal.RelationClasses.StaticSalesOrderHeaderRelations.SalesTerritoryEntityUsingTerritoryIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SalesOrderDetailEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SalesOrderDetailEntityFactory))), (IEntityRelation)GetRelationsForField("SalesOrderDetails")[0], (int)AdventureWorks.Dal.EntityType.SalesOrderHeaderEntity, (int)AdventureWorks.Dal.EntityType.SalesOrderDetailEntity, 0, null, null, null, null, "SalesOrderDetails", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SalesOrderHeaderSalesReasonEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SalesOrderHeaderSalesReasonEntityFactory))), (IEntityRelation)GetRelationsForField("SalesOrderHeaderSalesReasons")[0], (int)AdventureWorks.Dal.EntityType.SalesOrderHeaderEntity, (int)AdventureWorks.Dal.EntityType.SalesOrderHeaderSalesReasonEntity, 0, null, null, null, null, "SalesOrderHeaderSalesReasons", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathSalesReasonCollectionViaSalesOrderHeaderSalesReason
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<SalesReasonEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SalesReasonEntityFactory))), intermediateRelation,
					(int)AdventureWorks.Dal.EntityType.SalesOrderHeaderEntity, (int)AdventureWorks.Dal.EntityType.SalesReasonEntity, 0, null, null, GetRelationsForField("SalesReasonCollectionViaSalesOrderHeaderSalesReason"), null, "SalesReasonCollectionViaSalesOrderHeaderSalesReason", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathSpecialOfferProductCollectionViaSalesOrderDetail
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<SpecialOfferProductEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SpecialOfferProductEntityFactory))), intermediateRelation,
					(int)AdventureWorks.Dal.EntityType.SalesOrderHeaderEntity, (int)AdventureWorks.Dal.EntityType.SpecialOfferProductEntity, 0, null, null, GetRelationsForField("SpecialOfferProductCollectionViaSalesOrderDetail"), null, "SpecialOfferProductCollectionViaSalesOrderDetail", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AddressEntityFactory))),	(IEntityRelation)GetRelationsForField("Address")[0], (int)AdventureWorks.Dal.EntityType.SalesOrderHeaderEntity, (int)AdventureWorks.Dal.EntityType.AddressEntity, 0, null, null, null, null, "Address", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}

		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'Address' for this entity.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathAddress1
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AddressEntityFactory))),	(IEntityRelation)GetRelationsForField("Address1")[0], (int)AdventureWorks.Dal.EntityType.SalesOrderHeaderEntity, (int)AdventureWorks.Dal.EntityType.AddressEntity, 0, null, null, null, null, "Address1", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ShipMethodEntityFactory))),	(IEntityRelation)GetRelationsForField("ShipMethod")[0], (int)AdventureWorks.Dal.EntityType.SalesOrderHeaderEntity, (int)AdventureWorks.Dal.EntityType.ShipMethodEntity, 0, null, null, null, null, "ShipMethod", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CreditCardEntityFactory))),	(IEntityRelation)GetRelationsForField("CreditCard")[0], (int)AdventureWorks.Dal.EntityType.SalesOrderHeaderEntity, (int)AdventureWorks.Dal.EntityType.CreditCardEntity, 0, null, null, null, null, "CreditCard", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CustomerEntityFactory))),	(IEntityRelation)GetRelationsForField("Customer")[0], (int)AdventureWorks.Dal.EntityType.SalesOrderHeaderEntity, (int)AdventureWorks.Dal.EntityType.CustomerEntity, 0, null, null, null, null, "Customer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SalesPersonEntityFactory))),	(IEntityRelation)GetRelationsForField("SalesPerson")[0], (int)AdventureWorks.Dal.EntityType.SalesOrderHeaderEntity, (int)AdventureWorks.Dal.EntityType.SalesPersonEntity, 0, null, null, null, null, "SalesPerson", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SalesTerritoryEntityFactory))),	(IEntityRelation)GetRelationsForField("SalesTerritory")[0], (int)AdventureWorks.Dal.EntityType.SalesOrderHeaderEntity, (int)AdventureWorks.Dal.EntityType.SalesTerritoryEntity, 0, null, null, null, null, "SalesTerritory", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		public virtual EntityCollection<SalesReasonEntity> SalesReasonCollectionViaSalesOrderHeaderSalesReason
		{
			get { return GetOrCreateEntityCollection<SalesReasonEntity, SalesReasonEntityFactory>("SalesOrderHeaderCollectionViaSalesOrderHeaderSalesReason", false, true, ref _salesReasonCollectionViaSalesOrderHeaderSalesReason);	}
		}
		...
		public virtual EntityCollection<SpecialOfferProductEntity> SpecialOfferProductCollectionViaSalesOrderDetail
		{
			get { return GetOrCreateEntityCollection<SpecialOfferProductEntity, SpecialOfferProductEntityFactory>("SalesOrderHeaderCollectionViaSalesOrderDetail", false, true, ref _specialOfferProductCollectionViaSalesOrderDetail);	}
		}
		...
		/// <summary> Gets / sets related entity of type 'AddressEntity' which has to be set using a fetch action earlier. If no related entity is set for this property, null is returned..<br/><br/></summary>
		[Browsable(false)]
		public virtual AddressEntity Address1
		{
			...
			set
			{
				if(this.IsDeserializing)
				{
					SetupSyncAddress1(value);
				}
				else
				{
					SetSingleRelatedEntityNavigator(value, "SalesOrderHeaders1", "Address1", _address1, true); 
				}
			}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.SalesOrderHeaderEntity; }
		}
