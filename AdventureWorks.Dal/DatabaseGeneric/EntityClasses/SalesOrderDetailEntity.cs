			...
			
	{
		...
		private void SetupSyncSalesOrderHeader(IEntityCore relatedEntity)
		{
			if(_salesOrderHeader!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _salesOrderHeader, new PropertyChangedEventHandler( OnSalesOrderHeaderPropertyChanged ), "SalesOrderHeader", AdventureWorks.Dal.RelationClasses.StaticSalesOrderDetailRelations.SalesOrderHeaderEntityUsingSalesOrderIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncSpecialOfferProduct(IEntityCore relatedEntity)
		{
			if(_specialOfferProduct!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _specialOfferProduct, new PropertyChangedEventHandler( OnSpecialOfferProductPropertyChanged ), "SpecialOfferProduct", AdventureWorks.Dal.RelationClasses.StaticSalesOrderDetailRelations.SpecialOfferProductEntityUsingProductIdSpecialOfferIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SpecialOfferProductEntityFactory))),	(IEntityRelation)GetRelationsForField("SpecialOfferProduct")[0], (int)AdventureWorks.Dal.EntityType.SalesOrderDetailEntity, (int)AdventureWorks.Dal.EntityType.SpecialOfferProductEntity, 0, null, null, null, null, "SpecialOfferProduct", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.SalesOrderDetailEntity; }
		}
