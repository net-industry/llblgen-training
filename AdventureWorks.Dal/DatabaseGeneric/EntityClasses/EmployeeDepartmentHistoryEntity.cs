...
namespace AdventureWorks.Dal.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		/// <summary> CTor</summary>
		/// <param name="businessEntityId">PK value for EmployeeDepartmentHistory which data should be fetched into this EmployeeDepartmentHistory object</param>
		...
		public EmployeeDepartmentHistoryEntity(System.Int32 businessEntityId, System.Int16 departmentId, System.Byte shiftId, System.DateTime startDate):base("EmployeeDepartmentHistoryEntity")
		{
			InitClassEmpty(null, null);
		...
		/// <param name="validator">The custom validator object for this EmployeeDepartmentHistoryEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public EmployeeDepartmentHistoryEntity(System.Int32 businessEntityId, System.Int16 departmentId, System.Byte shiftId, System.DateTime startDate, IValidator validator):base("EmployeeDepartmentHistoryEntity")
		{
			InitClassEmpty(validator, null);
			this.BusinessEntityId = businessEntityId;
			this.DepartmentId = departmentId;
		...
		protected override void PerformDesyncSetupFKFieldChange(int fieldIndex)
		{
			...
			{
				case EmployeeDepartmentHistoryFieldIndex.BusinessEntityId:
		...
		{
			this.PerformDesetupSyncRelatedEntity( _department, new PropertyChangedEventHandler( OnDepartmentPropertyChanged ), "Department", AdventureWorks.Dal.RelationClasses.StaticEmployeeDepartmentHistoryRelations.DepartmentEntityUsingDepartmentIdStatic, true, signalRelatedEntity, "EmployeeDepartmentHistories", resetFKFields, new int[] { (int)EmployeeDepartmentHistoryFieldIndex.DepartmentId } );
			_department = null;
		}
		...
		private void SetupSyncDepartment(IEntityCore relatedEntity)
		{
			if(_department!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _department, new PropertyChangedEventHandler( OnDepartmentPropertyChanged ), "Department", AdventureWorks.Dal.RelationClasses.StaticEmployeeDepartmentHistoryRelations.DepartmentEntityUsingDepartmentIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", AdventureWorks.Dal.RelationClasses.StaticEmployeeDepartmentHistoryRelations.EmployeeEntityUsingBusinessEntityIdStatic, true, signalRelatedEntity, "EmployeeDepartmentHistories", resetFKFields, new int[] { (int)EmployeeDepartmentHistoryFieldIndex.BusinessEntityId } );
			_employee = null;
		}
		...
		private void SetupSyncEmployee(IEntityCore relatedEntity)
		{
			if(_employee!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", AdventureWorks.Dal.RelationClasses.StaticEmployeeDepartmentHistoryRelations.EmployeeEntityUsingBusinessEntityIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _shift, new PropertyChangedEventHandler( OnShiftPropertyChanged ), "Shift", AdventureWorks.Dal.RelationClasses.StaticEmployeeDepartmentHistoryRelations.ShiftEntityUsingShiftIdStatic, true, signalRelatedEntity, "EmployeeDepartmentHistories", resetFKFields, new int[] { (int)EmployeeDepartmentHistoryFieldIndex.ShiftId } );
			_shift = null;
		}
		...
		private void SetupSyncShift(IEntityCore relatedEntity)
		{
			if(_shift!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _shift, new PropertyChangedEventHandler( OnShiftPropertyChanged ), "Shift", AdventureWorks.Dal.RelationClasses.StaticEmployeeDepartmentHistoryRelations.ShiftEntityUsingShiftIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(DepartmentEntityFactory))),	(IEntityRelation)GetRelationsForField("Department")[0], (int)AdventureWorks.Dal.EntityType.EmployeeDepartmentHistoryEntity, (int)AdventureWorks.Dal.EntityType.DepartmentEntity, 0, null, null, null, null, "Department", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))),	(IEntityRelation)GetRelationsForField("Employee")[0], (int)AdventureWorks.Dal.EntityType.EmployeeDepartmentHistoryEntity, (int)AdventureWorks.Dal.EntityType.EmployeeEntity, 0, null, null, null, null, "Employee", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ShiftEntityFactory))),	(IEntityRelation)GetRelationsForField("Shift")[0], (int)AdventureWorks.Dal.EntityType.EmployeeDepartmentHistoryEntity, (int)AdventureWorks.Dal.EntityType.ShiftEntity, 0, null, null, null, null, "Shift", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The BusinessEntityId property of the Entity EmployeeDepartmentHistory<br/><br/></summary>
		...
		{
			get { return (System.Int32)GetValue((int)EmployeeDepartmentHistoryFieldIndex.BusinessEntityId, true); }
			set	{ SetValue((int)EmployeeDepartmentHistoryFieldIndex.BusinessEntityId, value); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.EmployeeDepartmentHistoryEntity; }
		}
