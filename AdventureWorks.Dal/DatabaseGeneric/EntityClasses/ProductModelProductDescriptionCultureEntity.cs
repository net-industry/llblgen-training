			...
			
	{
		...
		private void SetupSyncCulture(IEntityCore relatedEntity)
		{
			if(_culture!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _culture, new PropertyChangedEventHandler( OnCulturePropertyChanged ), "Culture", AdventureWorks.Dal.RelationClasses.StaticProductModelProductDescriptionCultureRelations.CultureEntityUsingCultureIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _productDescription, new PropertyChangedEventHandler( OnProductDescriptionPropertyChanged ), "ProductDescription", AdventureWorks.Dal.RelationClasses.StaticProductModelProductDescriptionCultureRelations.ProductDescriptionEntityUsingProductDescriptionIdStatic, true, signalRelatedEntity, "ProductModelProductDescriptionCultures", resetFKFields, new int[] { (int)ProductModelProductDescriptionCultureFieldIndex.ProductDescriptionId } );
		...
		private void SetupSyncProductDescription(IEntityCore relatedEntity)
		{
			if(_productDescription!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _productDescription, new PropertyChangedEventHandler( OnProductDescriptionPropertyChanged ), "ProductDescription", AdventureWorks.Dal.RelationClasses.StaticProductModelProductDescriptionCultureRelations.ProductDescriptionEntityUsingProductDescriptionIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncProductModel(IEntityCore relatedEntity)
		{
			if(_productModel!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _productModel, new PropertyChangedEventHandler( OnProductModelPropertyChanged ), "ProductModel", AdventureWorks.Dal.RelationClasses.StaticProductModelProductDescriptionCultureRelations.ProductModelEntityUsingProductModelIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CultureEntityFactory))),	(IEntityRelation)GetRelationsForField("Culture")[0], (int)AdventureWorks.Dal.EntityType.ProductModelProductDescriptionCultureEntity, (int)AdventureWorks.Dal.EntityType.CultureEntity, 0, null, null, null, null, "Culture", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductDescriptionEntityFactory))),	(IEntityRelation)GetRelationsForField("ProductDescription")[0], (int)AdventureWorks.Dal.EntityType.ProductModelProductDescriptionCultureEntity, (int)AdventureWorks.Dal.EntityType.ProductDescriptionEntity, 0, null, null, null, null, "ProductDescription", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductModelEntityFactory))),	(IEntityRelation)GetRelationsForField("ProductModel")[0], (int)AdventureWorks.Dal.EntityType.ProductModelProductDescriptionCultureEntity, (int)AdventureWorks.Dal.EntityType.ProductModelEntity, 0, null, null, null, null, "ProductModel", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.ProductModelProductDescriptionCultureEntity; }
		}
