...
namespace AdventureWorks.Dal.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private EntityCollection<ProductEntity> _productCollectionViaProductDocument;
		...
		protected DocumentEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_productCollectionViaProductDocument = (EntityCollection<ProductEntity>)info.GetValue("_productCollectionViaProductDocument", typeof(EntityCollection<ProductEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "ProductCollectionViaProductDocument":
					this.ProductCollectionViaProductDocument.IsReadOnly = false;
					this.ProductCollectionViaProductDocument.Add((ProductEntity)entity);
					this.ProductCollectionViaProductDocument.IsReadOnly = true;
					break;
				default:
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "ProductDocuments":
					...
					break;
				case "ProductCollectionViaProductDocument":
					toReturn.Add(Relations.ProductDocumentEntityUsingDocumentNode, "DocumentEntity__", "ProductDocument_", JoinHint.None);
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				info.AddValue("_productCollectionViaProductDocument", ((_productCollectionViaProductDocument!=null) && (_productCollectionViaProductDocument.Count>0) && !this.MarkedForDeletion)?_productCollectionViaProductDocument:null);
		...
		public IPredicateExpression ConstructFilterForUCRowguid()
		{
			...
			filter.Add(AdventureWorks.Dal.HelperClasses.DocumentFields.Rowguid == this.Fields.GetCurrentValue((int)DocumentFieldIndex.Rowguid));
 			return filter;
		}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoProductCollectionViaProductDocument()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("ProductCollectionViaProductDocument"));
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(DocumentFields.DocumentNode, null, ComparisonOperator.Equal, this.DocumentNode, "DocumentEntity__"));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(EmployeeFields.BusinessEntityId, null, ComparisonOperator.Equal, this.Owner));
			return bucket;
		}
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._productCollectionViaProductDocument);
		}
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._productCollectionViaProductDocument = (EntityCollection<ProductEntity>) collectionsQueue.Dequeue();
		...
		protected override bool HasPopulatedMemberEntityCollections()
		{
			...
			toReturn |= (this._productCollectionViaProductDocument != null);
		...
		{
			this.PerformDesetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", AdventureWorks.Dal.RelationClasses.StaticDocumentRelations.EmployeeEntityUsingOwnerStatic, true, signalRelatedEntity, "Documents", resetFKFields, new int[] { (int)DocumentFieldIndex.Owner } );
			_employee = null;
		}
		...
		private void SetupSyncEmployee(IEntityCore relatedEntity)
		{
			if(_employee!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", AdventureWorks.Dal.RelationClasses.StaticDocumentRelations.EmployeeEntityUsingOwnerStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ProductDocumentEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductDocumentEntityFactory))), (IEntityRelation)GetRelationsForField("ProductDocuments")[0], (int)AdventureWorks.Dal.EntityType.DocumentEntity, (int)AdventureWorks.Dal.EntityType.ProductDocumentEntity, 0, null, null, null, null, "ProductDocuments", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}

		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'Product' for this entity.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathProductCollectionViaProductDocument
		{
			get
			{
				IEntityRelation intermediateRelation = Relations.ProductDocumentEntityUsingDocumentNode;
				...
				return new PrefetchPathElement2(new EntityCollection<ProductEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))), intermediateRelation,
					(int)AdventureWorks.Dal.EntityType.DocumentEntity, (int)AdventureWorks.Dal.EntityType.ProductEntity, 0, null, null, GetRelationsForField("ProductCollectionViaProductDocument"), null, "ProductCollectionViaProductDocument", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))),	(IEntityRelation)GetRelationsForField("Employee")[0], (int)AdventureWorks.Dal.EntityType.DocumentEntity, (int)AdventureWorks.Dal.EntityType.EmployeeEntity, 0, null, null, null, null, "Employee", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		public virtual EntityCollection<ProductEntity> ProductCollectionViaProductDocument
		{
			get { return GetOrCreateEntityCollection<ProductEntity, ProductEntityFactory>("DocumentCollectionViaProductDocument", false, true, ref _productCollectionViaProductDocument);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.DocumentEntity; }
		}
