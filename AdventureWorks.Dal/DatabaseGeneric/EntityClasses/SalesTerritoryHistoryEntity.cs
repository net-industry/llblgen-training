...
namespace AdventureWorks.Dal.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		/// <summary> CTor</summary>
		/// <param name="businessEntityId">PK value for SalesTerritoryHistory which data should be fetched into this SalesTerritoryHistory object</param>
		...
		public SalesTerritoryHistoryEntity(System.Int32 businessEntityId, System.DateTime startDate, System.Int32 territoryId):base("SalesTerritoryHistoryEntity")
		{
			InitClassEmpty(null, null);
		...
		/// <param name="validator">The custom validator object for this SalesTerritoryHistoryEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public SalesTerritoryHistoryEntity(System.Int32 businessEntityId, System.DateTime startDate, System.Int32 territoryId, IValidator validator):base("SalesTerritoryHistoryEntity")
		{
			InitClassEmpty(validator, null);
			this.BusinessEntityId = businessEntityId;
			this.StartDate = startDate;
		...
		protected override void PerformDesyncSetupFKFieldChange(int fieldIndex)
		{
			...
			{
				case SalesTerritoryHistoryFieldIndex.BusinessEntityId:
		...
		private void SetupSyncSalesPerson(IEntityCore relatedEntity)
		{
			if(_salesPerson!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _salesPerson, new PropertyChangedEventHandler( OnSalesPersonPropertyChanged ), "SalesPerson", AdventureWorks.Dal.RelationClasses.StaticSalesTerritoryHistoryRelations.SalesPersonEntityUsingBusinessEntityIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _salesTerritory, new PropertyChangedEventHandler( OnSalesTerritoryPropertyChanged ), "SalesTerritory", AdventureWorks.Dal.RelationClasses.StaticSalesTerritoryHistoryRelations.SalesTerritoryEntityUsingTerritoryIdStatic, true, signalRelatedEntity, "SalesTerritoryHistories", resetFKFields, new int[] { (int)SalesTerritoryHistoryFieldIndex.TerritoryId } );
		...
		private void SetupSyncSalesTerritory(IEntityCore relatedEntity)
		{
			if(_salesTerritory!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _salesTerritory, new PropertyChangedEventHandler( OnSalesTerritoryPropertyChanged ), "SalesTerritory", AdventureWorks.Dal.RelationClasses.StaticSalesTerritoryHistoryRelations.SalesTerritoryEntityUsingTerritoryIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SalesPersonEntityFactory))),	(IEntityRelation)GetRelationsForField("SalesPerson")[0], (int)AdventureWorks.Dal.EntityType.SalesTerritoryHistoryEntity, (int)AdventureWorks.Dal.EntityType.SalesPersonEntity, 0, null, null, null, null, "SalesPerson", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SalesTerritoryEntityFactory))),	(IEntityRelation)GetRelationsForField("SalesTerritory")[0], (int)AdventureWorks.Dal.EntityType.SalesTerritoryHistoryEntity, (int)AdventureWorks.Dal.EntityType.SalesTerritoryEntity, 0, null, null, null, null, "SalesTerritory", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The BusinessEntityId property of the Entity SalesTerritoryHistory<br/><br/></summary>
		...
		{
			get { return (System.Int32)GetValue((int)SalesTerritoryHistoryFieldIndex.BusinessEntityId, true); }
			set	{ SetValue((int)SalesTerritoryHistoryFieldIndex.BusinessEntityId, value); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.SalesTerritoryHistoryEntity; }
		}
