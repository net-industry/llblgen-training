...
namespace AdventureWorks.Dal.EntityClasses
{
			...
			
	{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _person, new PropertyChangedEventHandler( OnPersonPropertyChanged ), "Person", AdventureWorks.Dal.RelationClasses.StaticPasswordRelations.PersonEntityUsingBusinessEntityIdStatic, true, signalRelatedEntity, "Password", false, new int[] { (int)PasswordFieldIndex.BusinessEntityId } );
			_person = null;
		}
		...
		private void SetupSyncPerson(IEntityCore relatedEntity)
		{
			if(_person!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _person, new PropertyChangedEventHandler( OnPersonPropertyChanged ), "Person", AdventureWorks.Dal.RelationClasses.StaticPasswordRelations.PersonEntityUsingBusinessEntityIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get { return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PersonEntityFactory))), (IEntityRelation)GetRelationsForField("Person")[0], (int)AdventureWorks.Dal.EntityType.PasswordEntity, (int)AdventureWorks.Dal.EntityType.PersonEntity, 0, null, null, null, null, "Person", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.PasswordEntity; }
		}
