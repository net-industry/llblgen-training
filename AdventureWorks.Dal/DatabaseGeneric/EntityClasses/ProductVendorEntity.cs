...
namespace AdventureWorks.Dal.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		/// <summary> CTor</summary>
		/// <param name="businessEntityId">PK value for ProductVendor which data should be fetched into this ProductVendor object</param>
		...
		public ProductVendorEntity(System.Int32 businessEntityId, System.Int32 productId):base("ProductVendorEntity")
		{
			InitClassEmpty(null, null);
		...
		/// <param name="validator">The custom validator object for this ProductVendorEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ProductVendorEntity(System.Int32 businessEntityId, System.Int32 productId, IValidator validator):base("ProductVendorEntity")
		{
			InitClassEmpty(validator, null);
			this.BusinessEntityId = businessEntityId;
			this.ProductId = productId;
		...
		protected override void PerformDesyncSetupFKFieldChange(int fieldIndex)
		{
			...
			{
				case ProductVendorFieldIndex.BusinessEntityId:
		...
		private void SetupSyncProduct(IEntityCore relatedEntity)
		{
			if(_product!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AdventureWorks.Dal.RelationClasses.StaticProductVendorRelations.ProductEntityUsingProductIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncUnitMeasure(IEntityCore relatedEntity)
		{
			if(_unitMeasure!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _unitMeasure, new PropertyChangedEventHandler( OnUnitMeasurePropertyChanged ), "UnitMeasure", AdventureWorks.Dal.RelationClasses.StaticProductVendorRelations.UnitMeasureEntityUsingUnitMeasureCodeStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _vendor, new PropertyChangedEventHandler( OnVendorPropertyChanged ), "Vendor", AdventureWorks.Dal.RelationClasses.StaticProductVendorRelations.VendorEntityUsingBusinessEntityIdStatic, true, signalRelatedEntity, "ProductVendors", resetFKFields, new int[] { (int)ProductVendorFieldIndex.BusinessEntityId } );
			_vendor = null;
		}
		...
		private void SetupSyncVendor(IEntityCore relatedEntity)
		{
			if(_vendor!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _vendor, new PropertyChangedEventHandler( OnVendorPropertyChanged ), "Vendor", AdventureWorks.Dal.RelationClasses.StaticProductVendorRelations.VendorEntityUsingBusinessEntityIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))),	(IEntityRelation)GetRelationsForField("Product")[0], (int)AdventureWorks.Dal.EntityType.ProductVendorEntity, (int)AdventureWorks.Dal.EntityType.ProductEntity, 0, null, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UnitMeasureEntityFactory))),	(IEntityRelation)GetRelationsForField("UnitMeasure")[0], (int)AdventureWorks.Dal.EntityType.ProductVendorEntity, (int)AdventureWorks.Dal.EntityType.UnitMeasureEntity, 0, null, null, null, null, "UnitMeasure", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(VendorEntityFactory))),	(IEntityRelation)GetRelationsForField("Vendor")[0], (int)AdventureWorks.Dal.EntityType.ProductVendorEntity, (int)AdventureWorks.Dal.EntityType.VendorEntity, 0, null, null, null, null, "Vendor", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The BusinessEntityId property of the Entity ProductVendor<br/><br/></summary>
		...
		{
			get { return (System.Int32)GetValue((int)ProductVendorFieldIndex.BusinessEntityId, true); }
			set	{ SetValue((int)ProductVendorFieldIndex.BusinessEntityId, value); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.ProductVendorEntity; }
		}
