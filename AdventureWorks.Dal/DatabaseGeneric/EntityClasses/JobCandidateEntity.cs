...
namespace AdventureWorks.Dal.EntityClasses
{
			...
			
	{
		...
		protected override void PerformDesyncSetupFKFieldChange(int fieldIndex)
		{
			...
			{
				case JobCandidateFieldIndex.BusinessEntityId:
		...
		private void SetupSyncEmployee(IEntityCore relatedEntity)
		{
			if(_employee!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", AdventureWorks.Dal.RelationClasses.StaticJobCandidateRelations.EmployeeEntityUsingBusinessEntityIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))),	(IEntityRelation)GetRelationsForField("Employee")[0], (int)AdventureWorks.Dal.EntityType.JobCandidateEntity, (int)AdventureWorks.Dal.EntityType.EmployeeEntity, 0, null, null, null, null, "Employee", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The BusinessEntityId property of the Entity JobCandidate<br/><br/></summary>
		/// <remarks>Mapped on  table field: "JobCandidate"."BusinessEntityID"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Int32> BusinessEntityId
		{
			get { return (Nullable<System.Int32>)GetValue((int)JobCandidateFieldIndex.BusinessEntityId, false); }
			set	{ SetValue((int)JobCandidateFieldIndex.BusinessEntityId, value); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.JobCandidateEntity; }
		}
