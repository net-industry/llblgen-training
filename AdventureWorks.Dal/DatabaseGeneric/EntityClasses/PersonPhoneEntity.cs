			...
			
	{
		...
		private void SetupSyncPerson(IEntityCore relatedEntity)
		{
			if(_person!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _person, new PropertyChangedEventHandler( OnPersonPropertyChanged ), "Person", AdventureWorks.Dal.RelationClasses.StaticPersonPhoneRelations.PersonEntityUsingBusinessEntityIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncPhoneNumberType(IEntityCore relatedEntity)
		{
			if(_phoneNumberType!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _phoneNumberType, new PropertyChangedEventHandler( OnPhoneNumberTypePropertyChanged ), "PhoneNumberType", AdventureWorks.Dal.RelationClasses.StaticPersonPhoneRelations.PhoneNumberTypeEntityUsingPhoneNumberTypeIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PersonEntityFactory))),	(IEntityRelation)GetRelationsForField("Person")[0], (int)AdventureWorks.Dal.EntityType.PersonPhoneEntity, (int)AdventureWorks.Dal.EntityType.PersonEntity, 0, null, null, null, null, "Person", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PhoneNumberTypeEntityFactory))),	(IEntityRelation)GetRelationsForField("PhoneNumberType")[0], (int)AdventureWorks.Dal.EntityType.PersonPhoneEntity, (int)AdventureWorks.Dal.EntityType.PhoneNumberTypeEntity, 0, null, null, null, null, "PhoneNumberType", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.PersonPhoneEntity; }
		}
