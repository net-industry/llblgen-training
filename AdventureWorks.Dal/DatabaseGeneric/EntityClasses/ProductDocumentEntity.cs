			...
			
	{
		...
		private void SetupSyncDocument(IEntityCore relatedEntity)
		{
			if(_document!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _document, new PropertyChangedEventHandler( OnDocumentPropertyChanged ), "Document", AdventureWorks.Dal.RelationClasses.StaticProductDocumentRelations.DocumentEntityUsingDocumentNodeStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncProduct(IEntityCore relatedEntity)
		{
			if(_product!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AdventureWorks.Dal.RelationClasses.StaticProductDocumentRelations.ProductEntityUsingProductIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))),	(IEntityRelation)GetRelationsForField("Product")[0], (int)AdventureWorks.Dal.EntityType.ProductDocumentEntity, (int)AdventureWorks.Dal.EntityType.ProductEntity, 0, null, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.ProductDocumentEntity; }
		}
