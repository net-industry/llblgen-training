...
namespace AdventureWorks.Dal.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private EntityCollection<SalesOrderHeaderEntity> _salesOrderHeaderCollectionViaSalesOrderDetail;
		...
		protected SpecialOfferProductEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_salesOrderHeaderCollectionViaSalesOrderDetail = (EntityCollection<SalesOrderHeaderEntity>)info.GetValue("_salesOrderHeaderCollectionViaSalesOrderDetail", typeof(EntityCollection<SalesOrderHeaderEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "SalesOrderHeaderCollectionViaSalesOrderDetail":
					this.SalesOrderHeaderCollectionViaSalesOrderDetail.IsReadOnly = false;
					this.SalesOrderHeaderCollectionViaSalesOrderDetail.Add((SalesOrderHeaderEntity)entity);
					this.SalesOrderHeaderCollectionViaSalesOrderDetail.IsReadOnly = true;
					break;
				default:
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				info.AddValue("_salesOrderHeaderCollectionViaSalesOrderDetail", ((_salesOrderHeaderCollectionViaSalesOrderDetail!=null) && (_salesOrderHeaderCollectionViaSalesOrderDetail.Count>0) && !this.MarkedForDeletion)?_salesOrderHeaderCollectionViaSalesOrderDetail:null);
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoSalesOrderHeaderCollectionViaSalesOrderDetail()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("SalesOrderHeaderCollectionViaSalesOrderDetail"));
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(SpecialOfferProductFields.ProductId, null, ComparisonOperator.Equal, this.ProductId, "SpecialOfferProductEntity__"));
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(SpecialOfferProductFields.SpecialOfferId, null, ComparisonOperator.Equal, this.SpecialOfferId, "SpecialOfferProductEntity__"));
			return bucket;
		}
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._salesOrderHeaderCollectionViaSalesOrderDetail);
		}
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._salesOrderHeaderCollectionViaSalesOrderDetail = (EntityCollection<SalesOrderHeaderEntity>) collectionsQueue.Dequeue();
		...
		protected override bool HasPopulatedMemberEntityCollections()
		{
			...
			toReturn |= (this._salesOrderHeaderCollectionViaSalesOrderDetail != null);
		...
		{
			this.PerformDesetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AdventureWorks.Dal.RelationClasses.StaticSpecialOfferProductRelations.ProductEntityUsingProductIdStatic, true, signalRelatedEntity, "SpecialOfferProducts", resetFKFields, new int[] { (int)SpecialOfferProductFieldIndex.ProductId } );
			_product = null;
		}
		...
		private void SetupSyncProduct(IEntityCore relatedEntity)
		{
			if(_product!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AdventureWorks.Dal.RelationClasses.StaticSpecialOfferProductRelations.ProductEntityUsingProductIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _specialOffer, new PropertyChangedEventHandler( OnSpecialOfferPropertyChanged ), "SpecialOffer", AdventureWorks.Dal.RelationClasses.StaticSpecialOfferProductRelations.SpecialOfferEntityUsingSpecialOfferIdStatic, true, signalRelatedEntity, "SpecialOfferProducts", resetFKFields, new int[] { (int)SpecialOfferProductFieldIndex.SpecialOfferId } );
			_specialOffer = null;
		}
		...
		private void SetupSyncSpecialOffer(IEntityCore relatedEntity)
		{
			if(_specialOffer!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _specialOffer, new PropertyChangedEventHandler( OnSpecialOfferPropertyChanged ), "SpecialOffer", AdventureWorks.Dal.RelationClasses.StaticSpecialOfferProductRelations.SpecialOfferEntityUsingSpecialOfferIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SalesOrderDetailEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SalesOrderDetailEntityFactory))), (IEntityRelation)GetRelationsForField("SalesOrderDetails")[0], (int)AdventureWorks.Dal.EntityType.SpecialOfferProductEntity, (int)AdventureWorks.Dal.EntityType.SalesOrderDetailEntity, 0, null, null, null, null, "SalesOrderDetails", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathSalesOrderHeaderCollectionViaSalesOrderDetail
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<SalesOrderHeaderEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SalesOrderHeaderEntityFactory))), intermediateRelation,
					(int)AdventureWorks.Dal.EntityType.SpecialOfferProductEntity, (int)AdventureWorks.Dal.EntityType.SalesOrderHeaderEntity, 0, null, null, GetRelationsForField("SalesOrderHeaderCollectionViaSalesOrderDetail"), null, "SalesOrderHeaderCollectionViaSalesOrderDetail", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))),	(IEntityRelation)GetRelationsForField("Product")[0], (int)AdventureWorks.Dal.EntityType.SpecialOfferProductEntity, (int)AdventureWorks.Dal.EntityType.ProductEntity, 0, null, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		public virtual EntityCollection<SalesOrderHeaderEntity> SalesOrderHeaderCollectionViaSalesOrderDetail
		{
			get { return GetOrCreateEntityCollection<SalesOrderHeaderEntity, SalesOrderHeaderEntityFactory>("SpecialOfferProductCollectionViaSalesOrderDetail", false, true, ref _salesOrderHeaderCollectionViaSalesOrderDetail);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.SpecialOfferProductEntity; }
		}
