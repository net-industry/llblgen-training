...
namespace AdventureWorks.Dal.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private EntityCollection<ProductEntity> _productCollectionViaPurchaseOrderDetail;
		...
		protected PurchaseOrderHeaderEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_productCollectionViaPurchaseOrderDetail = (EntityCollection<ProductEntity>)info.GetValue("_productCollectionViaPurchaseOrderDetail", typeof(EntityCollection<ProductEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "ProductCollectionViaPurchaseOrderDetail":
					this.ProductCollectionViaPurchaseOrderDetail.IsReadOnly = false;
					this.ProductCollectionViaPurchaseOrderDetail.Add((ProductEntity)entity);
					this.ProductCollectionViaPurchaseOrderDetail.IsReadOnly = true;
					break;
				default:
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "PurchaseOrderDetails":
					...
					break;
				case "ProductCollectionViaPurchaseOrderDetail":
					toReturn.Add(Relations.PurchaseOrderDetailEntityUsingPurchaseOrderId, "PurchaseOrderHeaderEntity__", "PurchaseOrderDetail_", JoinHint.None);
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				info.AddValue("_productCollectionViaPurchaseOrderDetail", ((_productCollectionViaPurchaseOrderDetail!=null) && (_productCollectionViaPurchaseOrderDetail.Count>0) && !this.MarkedForDeletion)?_productCollectionViaPurchaseOrderDetail:null);
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoProductCollectionViaPurchaseOrderDetail()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("ProductCollectionViaPurchaseOrderDetail"));
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(PurchaseOrderHeaderFields.PurchaseOrderId, null, ComparisonOperator.Equal, this.PurchaseOrderId, "PurchaseOrderHeaderEntity__"));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(EmployeeFields.BusinessEntityId, null, ComparisonOperator.Equal, this.EmployeeId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(VendorFields.BusinessEntityId, null, ComparisonOperator.Equal, this.VendorId));
			return bucket;
		}
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._productCollectionViaPurchaseOrderDetail);
		}
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._productCollectionViaPurchaseOrderDetail = (EntityCollection<ProductEntity>) collectionsQueue.Dequeue();
		...
		protected override bool HasPopulatedMemberEntityCollections()
		{
			...
			toReturn |= (this._productCollectionViaPurchaseOrderDetail != null);
		...
		private void SetupSyncEmployee(IEntityCore relatedEntity)
		{
			if(_employee!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", AdventureWorks.Dal.RelationClasses.StaticPurchaseOrderHeaderRelations.EmployeeEntityUsingEmployeeIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncShipMethod(IEntityCore relatedEntity)
		{
			if(_shipMethod!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _shipMethod, new PropertyChangedEventHandler( OnShipMethodPropertyChanged ), "ShipMethod", AdventureWorks.Dal.RelationClasses.StaticPurchaseOrderHeaderRelations.ShipMethodEntityUsingShipMethodIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncVendor(IEntityCore relatedEntity)
		{
			if(_vendor!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _vendor, new PropertyChangedEventHandler( OnVendorPropertyChanged ), "Vendor", AdventureWorks.Dal.RelationClasses.StaticPurchaseOrderHeaderRelations.VendorEntityUsingVendorIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<PurchaseOrderDetailEntity>(EntityFactoryCache2.GetEntityFactory(typeof(PurchaseOrderDetailEntityFactory))), (IEntityRelation)GetRelationsForField("PurchaseOrderDetails")[0], (int)AdventureWorks.Dal.EntityType.PurchaseOrderHeaderEntity, (int)AdventureWorks.Dal.EntityType.PurchaseOrderDetailEntity, 0, null, null, null, null, "PurchaseOrderDetails", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}

		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'Product' for this entity.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathProductCollectionViaPurchaseOrderDetail
		{
			get
			{
				IEntityRelation intermediateRelation = Relations.PurchaseOrderDetailEntityUsingPurchaseOrderId;
				...
				return new PrefetchPathElement2(new EntityCollection<ProductEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))), intermediateRelation,
					(int)AdventureWorks.Dal.EntityType.PurchaseOrderHeaderEntity, (int)AdventureWorks.Dal.EntityType.ProductEntity, 0, null, null, GetRelationsForField("ProductCollectionViaPurchaseOrderDetail"), null, "ProductCollectionViaPurchaseOrderDetail", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))),	(IEntityRelation)GetRelationsForField("Employee")[0], (int)AdventureWorks.Dal.EntityType.PurchaseOrderHeaderEntity, (int)AdventureWorks.Dal.EntityType.EmployeeEntity, 0, null, null, null, null, "Employee", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ShipMethodEntityFactory))),	(IEntityRelation)GetRelationsForField("ShipMethod")[0], (int)AdventureWorks.Dal.EntityType.PurchaseOrderHeaderEntity, (int)AdventureWorks.Dal.EntityType.ShipMethodEntity, 0, null, null, null, null, "ShipMethod", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(VendorEntityFactory))),	(IEntityRelation)GetRelationsForField("Vendor")[0], (int)AdventureWorks.Dal.EntityType.PurchaseOrderHeaderEntity, (int)AdventureWorks.Dal.EntityType.VendorEntity, 0, null, null, null, null, "Vendor", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		public virtual EntityCollection<ProductEntity> ProductCollectionViaPurchaseOrderDetail
		{
			get { return GetOrCreateEntityCollection<ProductEntity, ProductEntityFactory>("PurchaseOrderHeaderCollectionViaPurchaseOrderDetail", false, true, ref _productCollectionViaPurchaseOrderDetail);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.PurchaseOrderHeaderEntity; }
		}
