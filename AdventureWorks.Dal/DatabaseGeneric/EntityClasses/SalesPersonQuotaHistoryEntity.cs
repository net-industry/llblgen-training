...
namespace AdventureWorks.Dal.EntityClasses
{
			...
			
	{
		...
		/// <summary> CTor</summary>
		/// <param name="businessEntityId">PK value for SalesPersonQuotaHistory which data should be fetched into this SalesPersonQuotaHistory object</param>
		...
		public SalesPersonQuotaHistoryEntity(System.Int32 businessEntityId, System.DateTime quotaDate):base("SalesPersonQuotaHistoryEntity")
		{
			InitClassEmpty(null, null);
		...
		/// <param name="validator">The custom validator object for this SalesPersonQuotaHistoryEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public SalesPersonQuotaHistoryEntity(System.Int32 businessEntityId, System.DateTime quotaDate, IValidator validator):base("SalesPersonQuotaHistoryEntity")
		{
			InitClassEmpty(validator, null);
			this.BusinessEntityId = businessEntityId;
			this.QuotaDate = quotaDate;
		...
		protected override void PerformDesyncSetupFKFieldChange(int fieldIndex)
		{
			...
			{
				case SalesPersonQuotaHistoryFieldIndex.BusinessEntityId:
		...
		private void SetupSyncSalesPerson(IEntityCore relatedEntity)
		{
			if(_salesPerson!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _salesPerson, new PropertyChangedEventHandler( OnSalesPersonPropertyChanged ), "SalesPerson", AdventureWorks.Dal.RelationClasses.StaticSalesPersonQuotaHistoryRelations.SalesPersonEntityUsingBusinessEntityIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SalesPersonEntityFactory))),	(IEntityRelation)GetRelationsForField("SalesPerson")[0], (int)AdventureWorks.Dal.EntityType.SalesPersonQuotaHistoryEntity, (int)AdventureWorks.Dal.EntityType.SalesPersonEntity, 0, null, null, null, null, "SalesPerson", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The BusinessEntityId property of the Entity SalesPersonQuotaHistory<br/><br/></summary>
		...
		{
			get { return (System.Int32)GetValue((int)SalesPersonQuotaHistoryFieldIndex.BusinessEntityId, true); }
			set	{ SetValue((int)SalesPersonQuotaHistoryFieldIndex.BusinessEntityId, value); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.SalesPersonQuotaHistoryEntity; }
		}
