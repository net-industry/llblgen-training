		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncProduct(IEntityCore relatedEntity)
		{
			if(_product!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AdventureWorks.Dal.RelationClasses.StaticPurchaseOrderDetailRelations.ProductEntityUsingProductIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncPurchaseOrderHeader(IEntityCore relatedEntity)
		{
			if(_purchaseOrderHeader!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _purchaseOrderHeader, new PropertyChangedEventHandler( OnPurchaseOrderHeaderPropertyChanged ), "PurchaseOrderHeader", AdventureWorks.Dal.RelationClasses.StaticPurchaseOrderDetailRelations.PurchaseOrderHeaderEntityUsingPurchaseOrderIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))),	(IEntityRelation)GetRelationsForField("Product")[0], (int)AdventureWorks.Dal.EntityType.PurchaseOrderDetailEntity, (int)AdventureWorks.Dal.EntityType.ProductEntity, 0, null, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PurchaseOrderHeaderEntityFactory))),	(IEntityRelation)GetRelationsForField("PurchaseOrderHeader")[0], (int)AdventureWorks.Dal.EntityType.PurchaseOrderDetailEntity, (int)AdventureWorks.Dal.EntityType.PurchaseOrderHeaderEntity, 0, null, null, null, null, "PurchaseOrderHeader", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.PurchaseOrderDetailEntity; }
		}
