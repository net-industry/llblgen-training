...
namespace AdventureWorks.Dal.EntityClasses
{
			...
			
	{
		...
		private EntityCollection<LocationEntity> _locationCollectionViaWorkOrderRouting;
		...
		protected WorkOrderEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_locationCollectionViaWorkOrderRouting = (EntityCollection<LocationEntity>)info.GetValue("_locationCollectionViaWorkOrderRouting", typeof(EntityCollection<LocationEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "LocationCollectionViaWorkOrderRouting":
					this.LocationCollectionViaWorkOrderRouting.IsReadOnly = false;
					this.LocationCollectionViaWorkOrderRouting.Add((LocationEntity)entity);
					this.LocationCollectionViaWorkOrderRouting.IsReadOnly = true;
					break;
				default:
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "WorkOrderRoutings":
					...
					break;
				case "LocationCollectionViaWorkOrderRouting":
					toReturn.Add(Relations.WorkOrderRoutingEntityUsingWorkOrderId, "WorkOrderEntity__", "WorkOrderRouting_", JoinHint.None);
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				info.AddValue("_locationCollectionViaWorkOrderRouting", ((_locationCollectionViaWorkOrderRouting!=null) && (_locationCollectionViaWorkOrderRouting.Count>0) && !this.MarkedForDeletion)?_locationCollectionViaWorkOrderRouting:null);
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoLocationCollectionViaWorkOrderRouting()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("LocationCollectionViaWorkOrderRouting"));
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._locationCollectionViaWorkOrderRouting);
		}
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._locationCollectionViaWorkOrderRouting = (EntityCollection<LocationEntity>) collectionsQueue.Dequeue();
		...
		protected override bool HasPopulatedMemberEntityCollections()
		{
			...
			toReturn |= (this._locationCollectionViaWorkOrderRouting != null);
		...
		{
			this.PerformDesetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AdventureWorks.Dal.RelationClasses.StaticWorkOrderRelations.ProductEntityUsingProductIdStatic, true, signalRelatedEntity, "WorkOrders", resetFKFields, new int[] { (int)WorkOrderFieldIndex.ProductId } );
			_product = null;
		}
		...
		private void SetupSyncProduct(IEntityCore relatedEntity)
		{
			if(_product!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AdventureWorks.Dal.RelationClasses.StaticWorkOrderRelations.ProductEntityUsingProductIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncScrapReason(IEntityCore relatedEntity)
		{
			if(_scrapReason!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _scrapReason, new PropertyChangedEventHandler( OnScrapReasonPropertyChanged ), "ScrapReason", AdventureWorks.Dal.RelationClasses.StaticWorkOrderRelations.ScrapReasonEntityUsingScrapReasonIdStatic, true, new string[] {  } );
			}
		}
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathLocationCollectionViaWorkOrderRouting
		{
			get
			{
				IEntityRelation intermediateRelation = Relations.WorkOrderRoutingEntityUsingWorkOrderId;
				...
				return new PrefetchPathElement2(new EntityCollection<LocationEntity>(EntityFactoryCache2.GetEntityFactory(typeof(LocationEntityFactory))), intermediateRelation,
					(int)AdventureWorks.Dal.EntityType.WorkOrderEntity, (int)AdventureWorks.Dal.EntityType.LocationEntity, 0, null, null, GetRelationsForField("LocationCollectionViaWorkOrderRouting"), null, "LocationCollectionViaWorkOrderRouting", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))),	(IEntityRelation)GetRelationsForField("Product")[0], (int)AdventureWorks.Dal.EntityType.WorkOrderEntity, (int)AdventureWorks.Dal.EntityType.ProductEntity, 0, null, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ScrapReasonEntityFactory))),	(IEntityRelation)GetRelationsForField("ScrapReason")[0], (int)AdventureWorks.Dal.EntityType.WorkOrderEntity, (int)AdventureWorks.Dal.EntityType.ScrapReasonEntity, 0, null, null, null, null, "ScrapReason", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		public virtual EntityCollection<LocationEntity> LocationCollectionViaWorkOrderRouting
		{
			get { return GetOrCreateEntityCollection<LocationEntity, LocationEntityFactory>("WorkOrderCollectionViaWorkOrderRouting", false, true, ref _locationCollectionViaWorkOrderRouting);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.WorkOrderEntity; }
		}
