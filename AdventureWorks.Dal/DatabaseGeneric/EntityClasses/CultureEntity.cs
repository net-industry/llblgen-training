...
namespace AdventureWorks.Dal.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public virtual IRelationPredicateBucket GetRelationInfoProductDescriptionCollectionViaProductModelProductDescriptionCulture()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(CultureFields.CultureId, null, ComparisonOperator.Equal, this.CultureId, "CultureEntity__"));
			return bucket;
		}
		...
		public static IPrefetchPathElement2 PrefetchPathProductDescriptionCollectionViaProductModelProductDescriptionCulture
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ProductDescriptionEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductDescriptionEntityFactory))), intermediateRelation,
					(int)AdventureWorks.Dal.EntityType.CultureEntity, (int)AdventureWorks.Dal.EntityType.ProductDescriptionEntity, 0, null, null, GetRelationsForField("ProductDescriptionCollectionViaProductModelProductDescriptionCulture"), null, "ProductDescriptionCollectionViaProductModelProductDescriptionCulture", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get { return GetOrCreateEntityCollection<ProductDescriptionEntity, ProductDescriptionEntityFactory>("CultureCollectionViaProductModelProductDescriptionCulture", false, true, ref _productDescriptionCollectionViaProductModelProductDescriptionCulture);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<ProductModelEntity, ProductModelEntityFactory>("CultureCollectionViaProductModelProductDescriptionCulture", false, true, ref _productModelCollectionViaProductModelProductDescriptionCulture);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.CultureEntity; }
		}
