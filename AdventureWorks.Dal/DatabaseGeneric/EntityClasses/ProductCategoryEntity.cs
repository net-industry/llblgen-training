...
namespace AdventureWorks.Dal.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ProductSubcategoryEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductSubcategoryEntityFactory))), (IEntityRelation)GetRelationsForField("ProductSubcategories")[0], (int)AdventureWorks.Dal.EntityType.ProductCategoryEntity, (int)AdventureWorks.Dal.EntityType.ProductSubcategoryEntity, 0, null, null, null, null, "ProductSubcategories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.ProductCategoryEntity; }
		}
