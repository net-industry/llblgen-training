...
namespace AdventureWorks.Dal.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private EntityCollection<ProductEntity> _productCollectionViaWorkOrder;
		...
		protected ScrapReasonEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_productCollectionViaWorkOrder = (EntityCollection<ProductEntity>)info.GetValue("_productCollectionViaWorkOrder", typeof(EntityCollection<ProductEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "ProductCollectionViaWorkOrder":
					this.ProductCollectionViaWorkOrder.IsReadOnly = false;
					this.ProductCollectionViaWorkOrder.Add((ProductEntity)entity);
					this.ProductCollectionViaWorkOrder.IsReadOnly = true;
					break;
				default:
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				case "WorkOrders":
					...
					break;
				case "ProductCollectionViaWorkOrder":
					toReturn.Add(Relations.WorkOrderEntityUsingScrapReasonId, "ScrapReasonEntity__", "WorkOrder_", JoinHint.None);
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				info.AddValue("_productCollectionViaWorkOrder", ((_productCollectionViaWorkOrder!=null) && (_productCollectionViaWorkOrder.Count>0) && !this.MarkedForDeletion)?_productCollectionViaWorkOrder:null);
			}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoProductCollectionViaWorkOrder()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("ProductCollectionViaWorkOrder"));
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ScrapReasonFields.ScrapReasonId, null, ComparisonOperator.Equal, this.ScrapReasonId, "ScrapReasonEntity__"));
			return bucket;
		}
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._productCollectionViaWorkOrder);
		}
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._productCollectionViaWorkOrder = (EntityCollection<ProductEntity>) collectionsQueue.Dequeue();
		...
		protected override bool HasPopulatedMemberEntityCollections()
		{
			...
			toReturn |= (this._productCollectionViaWorkOrder != null);
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<WorkOrderEntity>(EntityFactoryCache2.GetEntityFactory(typeof(WorkOrderEntityFactory))), (IEntityRelation)GetRelationsForField("WorkOrders")[0], (int)AdventureWorks.Dal.EntityType.ScrapReasonEntity, (int)AdventureWorks.Dal.EntityType.WorkOrderEntity, 0, null, null, null, null, "WorkOrders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}

		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'Product' for this entity.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathProductCollectionViaWorkOrder
		{
			get
			{
				IEntityRelation intermediateRelation = Relations.WorkOrderEntityUsingScrapReasonId;
				...
				return new PrefetchPathElement2(new EntityCollection<ProductEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))), intermediateRelation,
					(int)AdventureWorks.Dal.EntityType.ScrapReasonEntity, (int)AdventureWorks.Dal.EntityType.ProductEntity, 0, null, null, GetRelationsForField("ProductCollectionViaWorkOrder"), null, "ProductCollectionViaWorkOrder", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public virtual EntityCollection<ProductEntity> ProductCollectionViaWorkOrder
		{
			get { return GetOrCreateEntityCollection<ProductEntity, ProductEntityFactory>("ScrapReasonCollectionViaWorkOrder", false, true, ref _productCollectionViaWorkOrder);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.ScrapReasonEntity; }
		}
