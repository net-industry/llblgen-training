...
namespace AdventureWorks.Dal.EntityClasses
{
			...
			
	{
		...
		private EntityCollection<ProductEntity> _productCollectionViaProductInventory;
		private EntityCollection<WorkOrderEntity> _workOrderCollectionViaWorkOrderRouting;
		...
		protected LocationEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_productCollectionViaProductInventory = (EntityCollection<ProductEntity>)info.GetValue("_productCollectionViaProductInventory", typeof(EntityCollection<ProductEntity>));
				_workOrderCollectionViaWorkOrderRouting = (EntityCollection<WorkOrderEntity>)info.GetValue("_workOrderCollectionViaWorkOrderRouting", typeof(EntityCollection<WorkOrderEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "ProductCollectionViaProductInventory":
					this.ProductCollectionViaProductInventory.IsReadOnly = false;
					this.ProductCollectionViaProductInventory.Add((ProductEntity)entity);
					this.ProductCollectionViaProductInventory.IsReadOnly = true;
					break;
				case "WorkOrderCollectionViaWorkOrderRouting":
					this.WorkOrderCollectionViaWorkOrderRouting.IsReadOnly = false;
					this.WorkOrderCollectionViaWorkOrderRouting.Add((WorkOrderEntity)entity);
					this.WorkOrderCollectionViaWorkOrderRouting.IsReadOnly = true;
					break;
				default:
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "WorkOrderRoutings":
					...
					break;
				case "ProductCollectionViaProductInventory":
					toReturn.Add(Relations.ProductInventoryEntityUsingLocationId, "LocationEntity__", "ProductInventory_", JoinHint.None);
					toReturn.Add(ProductInventoryEntity.Relations.ProductEntityUsingProductId, "ProductInventory_", string.Empty, JoinHint.None);
					break;
				case "WorkOrderCollectionViaWorkOrderRouting":
					toReturn.Add(Relations.WorkOrderRoutingEntityUsingLocationId, "LocationEntity__", "WorkOrderRouting_", JoinHint.None);
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				info.AddValue("_productCollectionViaProductInventory", ((_productCollectionViaProductInventory!=null) && (_productCollectionViaProductInventory.Count>0) && !this.MarkedForDeletion)?_productCollectionViaProductInventory:null);
				info.AddValue("_workOrderCollectionViaWorkOrderRouting", ((_workOrderCollectionViaWorkOrderRouting!=null) && (_workOrderCollectionViaWorkOrderRouting.Count>0) && !this.MarkedForDeletion)?_workOrderCollectionViaWorkOrderRouting:null);
			}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoProductCollectionViaProductInventory()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("ProductCollectionViaProductInventory"));
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(LocationFields.LocationId, null, ComparisonOperator.Equal, this.LocationId, "LocationEntity__"));
			return bucket;
		}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoWorkOrderCollectionViaWorkOrderRouting()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("WorkOrderCollectionViaWorkOrderRouting"));
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(LocationFields.LocationId, null, ComparisonOperator.Equal, this.LocationId, "LocationEntity__"));
			return bucket;
		}
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._productCollectionViaProductInventory);
			collectionsQueue.Enqueue(this._workOrderCollectionViaWorkOrderRouting);
		}
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._productCollectionViaProductInventory = (EntityCollection<ProductEntity>) collectionsQueue.Dequeue();
			this._workOrderCollectionViaWorkOrderRouting = (EntityCollection<WorkOrderEntity>) collectionsQueue.Dequeue();
		...
		protected override bool HasPopulatedMemberEntityCollections()
		{
			...
			toReturn |= (this._productCollectionViaProductInventory != null);
			toReturn |= (this._workOrderCollectionViaWorkOrderRouting != null);
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ProductInventoryEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductInventoryEntityFactory))), (IEntityRelation)GetRelationsForField("ProductInventories")[0], (int)AdventureWorks.Dal.EntityType.LocationEntity, (int)AdventureWorks.Dal.EntityType.ProductInventoryEntity, 0, null, null, null, null, "ProductInventories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<WorkOrderRoutingEntity>(EntityFactoryCache2.GetEntityFactory(typeof(WorkOrderRoutingEntityFactory))), (IEntityRelation)GetRelationsForField("WorkOrderRoutings")[0], (int)AdventureWorks.Dal.EntityType.LocationEntity, (int)AdventureWorks.Dal.EntityType.WorkOrderRoutingEntity, 0, null, null, null, null, "WorkOrderRoutings", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}

		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'Product' for this entity.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathProductCollectionViaProductInventory
		{
			get
			{
				IEntityRelation intermediateRelation = Relations.ProductInventoryEntityUsingLocationId;
				...
				return new PrefetchPathElement2(new EntityCollection<ProductEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))), intermediateRelation,
					(int)AdventureWorks.Dal.EntityType.LocationEntity, (int)AdventureWorks.Dal.EntityType.ProductEntity, 0, null, null, GetRelationsForField("ProductCollectionViaProductInventory"), null, "ProductCollectionViaProductInventory", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathWorkOrderCollectionViaWorkOrderRouting
		{
			get
			{
				IEntityRelation intermediateRelation = Relations.WorkOrderRoutingEntityUsingLocationId;
				...
				return new PrefetchPathElement2(new EntityCollection<WorkOrderEntity>(EntityFactoryCache2.GetEntityFactory(typeof(WorkOrderEntityFactory))), intermediateRelation,
					(int)AdventureWorks.Dal.EntityType.LocationEntity, (int)AdventureWorks.Dal.EntityType.WorkOrderEntity, 0, null, null, GetRelationsForField("WorkOrderCollectionViaWorkOrderRouting"), null, "WorkOrderCollectionViaWorkOrderRouting", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public virtual EntityCollection<ProductEntity> ProductCollectionViaProductInventory
		{
			get { return GetOrCreateEntityCollection<ProductEntity, ProductEntityFactory>("LocationCollectionViaProductInventory", false, true, ref _productCollectionViaProductInventory);	}
		}

		/// <summary> Gets the EntityCollection with the related entities of type 'WorkOrderEntity' which are related to this entity via a relation of type 'm:n'. If the EntityCollection hasn't been fetched yet, the collection returned will be empty.<br/><br/></summary>
		[TypeContainedAttribute(typeof(WorkOrderEntity))]
		public virtual EntityCollection<WorkOrderEntity> WorkOrderCollectionViaWorkOrderRouting
		{
			get { return GetOrCreateEntityCollection<WorkOrderEntity, WorkOrderEntityFactory>("LocationCollectionViaWorkOrderRouting", false, true, ref _workOrderCollectionViaWorkOrderRouting);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.LocationEntity; }
		}
