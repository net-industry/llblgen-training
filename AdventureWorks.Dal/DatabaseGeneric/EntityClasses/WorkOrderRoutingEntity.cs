		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncLocation(IEntityCore relatedEntity)
		{
			if(_location!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _location, new PropertyChangedEventHandler( OnLocationPropertyChanged ), "Location", AdventureWorks.Dal.RelationClasses.StaticWorkOrderRoutingRelations.LocationEntityUsingLocationIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncWorkOrder(IEntityCore relatedEntity)
		{
			if(_workOrder!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _workOrder, new PropertyChangedEventHandler( OnWorkOrderPropertyChanged ), "WorkOrder", AdventureWorks.Dal.RelationClasses.StaticWorkOrderRoutingRelations.WorkOrderEntityUsingWorkOrderIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(LocationEntityFactory))),	(IEntityRelation)GetRelationsForField("Location")[0], (int)AdventureWorks.Dal.EntityType.WorkOrderRoutingEntity, (int)AdventureWorks.Dal.EntityType.LocationEntity, 0, null, null, null, null, "Location", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(WorkOrderEntityFactory))),	(IEntityRelation)GetRelationsForField("WorkOrder")[0], (int)AdventureWorks.Dal.EntityType.WorkOrderRoutingEntity, (int)AdventureWorks.Dal.EntityType.WorkOrderEntity, 0, null, null, null, null, "WorkOrder", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.WorkOrderRoutingEntity; }
		}
