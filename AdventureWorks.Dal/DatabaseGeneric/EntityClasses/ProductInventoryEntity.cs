...
namespace AdventureWorks.Dal.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _location, new PropertyChangedEventHandler( OnLocationPropertyChanged ), "Location", AdventureWorks.Dal.RelationClasses.StaticProductInventoryRelations.LocationEntityUsingLocationIdStatic, true, signalRelatedEntity, "ProductInventories", resetFKFields, new int[] { (int)ProductInventoryFieldIndex.LocationId } );
			_location = null;
		}
		...
		private void SetupSyncLocation(IEntityCore relatedEntity)
		{
			if(_location!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _location, new PropertyChangedEventHandler( OnLocationPropertyChanged ), "Location", AdventureWorks.Dal.RelationClasses.StaticProductInventoryRelations.LocationEntityUsingLocationIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AdventureWorks.Dal.RelationClasses.StaticProductInventoryRelations.ProductEntityUsingProductIdStatic, true, signalRelatedEntity, "ProductInventories", resetFKFields, new int[] { (int)ProductInventoryFieldIndex.ProductId } );
			_product = null;
		}
		...
		private void SetupSyncProduct(IEntityCore relatedEntity)
		{
			if(_product!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AdventureWorks.Dal.RelationClasses.StaticProductInventoryRelations.ProductEntityUsingProductIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(LocationEntityFactory))),	(IEntityRelation)GetRelationsForField("Location")[0], (int)AdventureWorks.Dal.EntityType.ProductInventoryEntity, (int)AdventureWorks.Dal.EntityType.LocationEntity, 0, null, null, null, null, "Location", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))),	(IEntityRelation)GetRelationsForField("Product")[0], (int)AdventureWorks.Dal.EntityType.ProductInventoryEntity, (int)AdventureWorks.Dal.EntityType.ProductEntity, 0, null, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.ProductInventoryEntity; }
		}
