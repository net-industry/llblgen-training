...
namespace AdventureWorks.Dal.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public virtual IRelationPredicateBucket GetRelationInfoProductModelCollectionViaProduct()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ProductSubcategoryFields.ProductSubcategoryId, null, ComparisonOperator.Equal, this.ProductSubcategoryId, "ProductSubcategoryEntity__"));
			return bucket;
		}
		...
		private void SetupSyncProductCategory(IEntityCore relatedEntity)
		{
			if(_productCategory!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _productCategory, new PropertyChangedEventHandler( OnProductCategoryPropertyChanged ), "ProductCategory", AdventureWorks.Dal.RelationClasses.StaticProductSubcategoryRelations.ProductCategoryEntityUsingProductCategoryIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ProductEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))), (IEntityRelation)GetRelationsForField("Products")[0], (int)AdventureWorks.Dal.EntityType.ProductSubcategoryEntity, (int)AdventureWorks.Dal.EntityType.ProductEntity, 0, null, null, null, null, "Products", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathProductModelCollectionViaProduct
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ProductModelEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductModelEntityFactory))), intermediateRelation,
					(int)AdventureWorks.Dal.EntityType.ProductSubcategoryEntity, (int)AdventureWorks.Dal.EntityType.ProductModelEntity, 0, null, null, GetRelationsForField("ProductModelCollectionViaProduct"), null, "ProductModelCollectionViaProduct", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathUnitMeasureCollectionViaProduct
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<UnitMeasureEntity>(EntityFactoryCache2.GetEntityFactory(typeof(UnitMeasureEntityFactory))), intermediateRelation,
					(int)AdventureWorks.Dal.EntityType.ProductSubcategoryEntity, (int)AdventureWorks.Dal.EntityType.UnitMeasureEntity, 0, null, null, GetRelationsForField("UnitMeasureCollectionViaProduct"), null, "UnitMeasureCollectionViaProduct", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathUnitMeasureCollectionViaProduct1
		{
			get
			{
				...
				intermediateRelation.SetAliases(string.Empty, "Product_");
				return new PrefetchPathElement2(new EntityCollection<UnitMeasureEntity>(EntityFactoryCache2.GetEntityFactory(typeof(UnitMeasureEntityFactory))), intermediateRelation,
					(int)AdventureWorks.Dal.EntityType.ProductSubcategoryEntity, (int)AdventureWorks.Dal.EntityType.UnitMeasureEntity, 0, null, null, GetRelationsForField("UnitMeasureCollectionViaProduct1"), null, "UnitMeasureCollectionViaProduct1", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductCategoryEntityFactory))),	(IEntityRelation)GetRelationsForField("ProductCategory")[0], (int)AdventureWorks.Dal.EntityType.ProductSubcategoryEntity, (int)AdventureWorks.Dal.EntityType.ProductCategoryEntity, 0, null, null, null, null, "ProductCategory", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get { return GetOrCreateEntityCollection<ProductModelEntity, ProductModelEntityFactory>("ProductSubcategoryCollectionViaProduct", false, true, ref _productModelCollectionViaProduct);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<UnitMeasureEntity, UnitMeasureEntityFactory>("ProductSubcategoryCollectionViaProduct", false, true, ref _unitMeasureCollectionViaProduct);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<UnitMeasureEntity, UnitMeasureEntityFactory>("ProductSubcategoryCollectionViaProduct1", false, true, ref _unitMeasureCollectionViaProduct1);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.ProductSubcategoryEntity; }
		}
