		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncIllustration(IEntityCore relatedEntity)
		{
			if(_illustration!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _illustration, new PropertyChangedEventHandler( OnIllustrationPropertyChanged ), "Illustration", AdventureWorks.Dal.RelationClasses.StaticProductModelIllustrationRelations.IllustrationEntityUsingIllustrationIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncProductModel(IEntityCore relatedEntity)
		{
			if(_productModel!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _productModel, new PropertyChangedEventHandler( OnProductModelPropertyChanged ), "ProductModel", AdventureWorks.Dal.RelationClasses.StaticProductModelIllustrationRelations.ProductModelEntityUsingProductModelIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(IllustrationEntityFactory))),	(IEntityRelation)GetRelationsForField("Illustration")[0], (int)AdventureWorks.Dal.EntityType.ProductModelIllustrationEntity, (int)AdventureWorks.Dal.EntityType.IllustrationEntity, 0, null, null, null, null, "Illustration", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductModelEntityFactory))),	(IEntityRelation)GetRelationsForField("ProductModel")[0], (int)AdventureWorks.Dal.EntityType.ProductModelIllustrationEntity, (int)AdventureWorks.Dal.EntityType.ProductModelEntity, 0, null, null, null, null, "ProductModel", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.ProductModelIllustrationEntity; }
		}
