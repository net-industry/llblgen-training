...
namespace AdventureWorks.Dal.EntityClasses
{
			...
			
	{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _businessEntity, new PropertyChangedEventHandler( OnBusinessEntityPropertyChanged ), "BusinessEntity", AdventureWorks.Dal.RelationClasses.StaticBusinessEntityContactRelations.BusinessEntityEntityUsingBusinessEntityIdStatic, true, signalRelatedEntity, "BusinessEntityContacts", resetFKFields, new int[] { (int)BusinessEntityContactFieldIndex.BusinessEntityId } );
		...
		private void SetupSyncBusinessEntity(IEntityCore relatedEntity)
		{
			if(_businessEntity!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _businessEntity, new PropertyChangedEventHandler( OnBusinessEntityPropertyChanged ), "BusinessEntity", AdventureWorks.Dal.RelationClasses.StaticBusinessEntityContactRelations.BusinessEntityEntityUsingBusinessEntityIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _contactType, new PropertyChangedEventHandler( OnContactTypePropertyChanged ), "ContactType", AdventureWorks.Dal.RelationClasses.StaticBusinessEntityContactRelations.ContactTypeEntityUsingContactTypeIdStatic, true, signalRelatedEntity, "BusinessEntityContacts", resetFKFields, new int[] { (int)BusinessEntityContactFieldIndex.ContactTypeId } );
			_contactType = null;
		}
		...
		private void SetupSyncContactType(IEntityCore relatedEntity)
		{
			if(_contactType!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _contactType, new PropertyChangedEventHandler( OnContactTypePropertyChanged ), "ContactType", AdventureWorks.Dal.RelationClasses.StaticBusinessEntityContactRelations.ContactTypeEntityUsingContactTypeIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncPerson(IEntityCore relatedEntity)
		{
			if(_person!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _person, new PropertyChangedEventHandler( OnPersonPropertyChanged ), "Person", AdventureWorks.Dal.RelationClasses.StaticBusinessEntityContactRelations.PersonEntityUsingPersonIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(BusinessEntityEntityFactory))),	(IEntityRelation)GetRelationsForField("BusinessEntity")[0], (int)AdventureWorks.Dal.EntityType.BusinessEntityContactEntity, (int)AdventureWorks.Dal.EntityType.BusinessEntityEntity, 0, null, null, null, null, "BusinessEntity", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ContactTypeEntityFactory))),	(IEntityRelation)GetRelationsForField("ContactType")[0], (int)AdventureWorks.Dal.EntityType.BusinessEntityContactEntity, (int)AdventureWorks.Dal.EntityType.ContactTypeEntity, 0, null, null, null, null, "ContactType", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PersonEntityFactory))),	(IEntityRelation)GetRelationsForField("Person")[0], (int)AdventureWorks.Dal.EntityType.BusinessEntityContactEntity, (int)AdventureWorks.Dal.EntityType.PersonEntity, 0, null, null, null, null, "Person", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.BusinessEntityContactEntity; }
		}
