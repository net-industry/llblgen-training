...
namespace AdventureWorks.Dal.EntityClasses
{
			...
			
	{
		...
		private EntityCollection<ProductModelEntity> _productModelCollectionViaProductModelIllustration;
		...
		protected IllustrationEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_productModelCollectionViaProductModelIllustration = (EntityCollection<ProductModelEntity>)info.GetValue("_productModelCollectionViaProductModelIllustration", typeof(EntityCollection<ProductModelEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "ProductModelCollectionViaProductModelIllustration":
					this.ProductModelCollectionViaProductModelIllustration.IsReadOnly = false;
					this.ProductModelCollectionViaProductModelIllustration.Add((ProductModelEntity)entity);
					this.ProductModelCollectionViaProductModelIllustration.IsReadOnly = true;
					break;
				default:
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				info.AddValue("_productModelCollectionViaProductModelIllustration", ((_productModelCollectionViaProductModelIllustration!=null) && (_productModelCollectionViaProductModelIllustration.Count>0) && !this.MarkedForDeletion)?_productModelCollectionViaProductModelIllustration:null);
			}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoProductModelCollectionViaProductModelIllustration()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("ProductModelCollectionViaProductModelIllustration"));
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(IllustrationFields.IllustrationId, null, ComparisonOperator.Equal, this.IllustrationId, "IllustrationEntity__"));
			return bucket;
		}
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._productModelCollectionViaProductModelIllustration);
		}
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._productModelCollectionViaProductModelIllustration = (EntityCollection<ProductModelEntity>) collectionsQueue.Dequeue();
		...
		protected override bool HasPopulatedMemberEntityCollections()
		{
			...
			toReturn |= (this._productModelCollectionViaProductModelIllustration != null);
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathProductModelCollectionViaProductModelIllustration
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ProductModelEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductModelEntityFactory))), intermediateRelation,
					(int)AdventureWorks.Dal.EntityType.IllustrationEntity, (int)AdventureWorks.Dal.EntityType.ProductModelEntity, 0, null, null, GetRelationsForField("ProductModelCollectionViaProductModelIllustration"), null, "ProductModelCollectionViaProductModelIllustration", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public virtual EntityCollection<ProductModelEntity> ProductModelCollectionViaProductModelIllustration
		{
			get { return GetOrCreateEntityCollection<ProductModelEntity, ProductModelEntityFactory>("IllustrationCollectionViaProductModelIllustration", false, true, ref _productModelCollectionViaProductModelIllustration);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.IllustrationEntity; }
		}
