...
namespace AdventureWorks.Dal.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private EntityCollection<SalesOrderHeaderEntity> _salesOrderHeaderCollectionViaSalesOrderHeaderSalesReason;
		...
		protected SalesReasonEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_salesOrderHeaderCollectionViaSalesOrderHeaderSalesReason = (EntityCollection<SalesOrderHeaderEntity>)info.GetValue("_salesOrderHeaderCollectionViaSalesOrderHeaderSalesReason", typeof(EntityCollection<SalesOrderHeaderEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "SalesOrderHeaderCollectionViaSalesOrderHeaderSalesReason":
					this.SalesOrderHeaderCollectionViaSalesOrderHeaderSalesReason.IsReadOnly = false;
					this.SalesOrderHeaderCollectionViaSalesOrderHeaderSalesReason.Add((SalesOrderHeaderEntity)entity);
					this.SalesOrderHeaderCollectionViaSalesOrderHeaderSalesReason.IsReadOnly = true;
					break;
				default:
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				info.AddValue("_salesOrderHeaderCollectionViaSalesOrderHeaderSalesReason", ((_salesOrderHeaderCollectionViaSalesOrderHeaderSalesReason!=null) && (_salesOrderHeaderCollectionViaSalesOrderHeaderSalesReason.Count>0) && !this.MarkedForDeletion)?_salesOrderHeaderCollectionViaSalesOrderHeaderSalesReason:null);
			}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoSalesOrderHeaderCollectionViaSalesOrderHeaderSalesReason()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("SalesOrderHeaderCollectionViaSalesOrderHeaderSalesReason"));
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(SalesReasonFields.SalesReasonId, null, ComparisonOperator.Equal, this.SalesReasonId, "SalesReasonEntity__"));
			return bucket;
		}
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._salesOrderHeaderCollectionViaSalesOrderHeaderSalesReason);
		}
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._salesOrderHeaderCollectionViaSalesOrderHeaderSalesReason = (EntityCollection<SalesOrderHeaderEntity>) collectionsQueue.Dequeue();
		...
		protected override bool HasPopulatedMemberEntityCollections()
		{
			...
			toReturn |= (this._salesOrderHeaderCollectionViaSalesOrderHeaderSalesReason != null);
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SalesOrderHeaderSalesReasonEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SalesOrderHeaderSalesReasonEntityFactory))), (IEntityRelation)GetRelationsForField("SalesOrderHeaderSalesReasons")[0], (int)AdventureWorks.Dal.EntityType.SalesReasonEntity, (int)AdventureWorks.Dal.EntityType.SalesOrderHeaderSalesReasonEntity, 0, null, null, null, null, "SalesOrderHeaderSalesReasons", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathSalesOrderHeaderCollectionViaSalesOrderHeaderSalesReason
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<SalesOrderHeaderEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SalesOrderHeaderEntityFactory))), intermediateRelation,
					(int)AdventureWorks.Dal.EntityType.SalesReasonEntity, (int)AdventureWorks.Dal.EntityType.SalesOrderHeaderEntity, 0, null, null, GetRelationsForField("SalesOrderHeaderCollectionViaSalesOrderHeaderSalesReason"), null, "SalesOrderHeaderCollectionViaSalesOrderHeaderSalesReason", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public virtual EntityCollection<SalesOrderHeaderEntity> SalesOrderHeaderCollectionViaSalesOrderHeaderSalesReason
		{
			get { return GetOrCreateEntityCollection<SalesOrderHeaderEntity, SalesOrderHeaderEntityFactory>("SalesReasonCollectionViaSalesOrderHeaderSalesReason", false, true, ref _salesOrderHeaderCollectionViaSalesOrderHeaderSalesReason);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.SalesReasonEntity; }
		}
