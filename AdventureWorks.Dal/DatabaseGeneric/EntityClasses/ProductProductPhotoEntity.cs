...
namespace AdventureWorks.Dal.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			this.PerformDesetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AdventureWorks.Dal.RelationClasses.StaticProductProductPhotoRelations.ProductEntityUsingProductIdStatic, true, signalRelatedEntity, "ProductProductPhotos", resetFKFields, new int[] { (int)ProductProductPhotoFieldIndex.ProductId } );
			_product = null;
		}
		...
		private void SetupSyncProduct(IEntityCore relatedEntity)
		{
			if(_product!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", AdventureWorks.Dal.RelationClasses.StaticProductProductPhotoRelations.ProductEntityUsingProductIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _productPhoto, new PropertyChangedEventHandler( OnProductPhotoPropertyChanged ), "ProductPhoto", AdventureWorks.Dal.RelationClasses.StaticProductProductPhotoRelations.ProductPhotoEntityUsingProductPhotoIdStatic, true, signalRelatedEntity, "ProductProductPhotos", resetFKFields, new int[] { (int)ProductProductPhotoFieldIndex.ProductPhotoId } );
			_productPhoto = null;
		}
		...
		private void SetupSyncProductPhoto(IEntityCore relatedEntity)
		{
			if(_productPhoto!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _productPhoto, new PropertyChangedEventHandler( OnProductPhotoPropertyChanged ), "ProductPhoto", AdventureWorks.Dal.RelationClasses.StaticProductProductPhotoRelations.ProductPhotoEntityUsingProductPhotoIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))),	(IEntityRelation)GetRelationsForField("Product")[0], (int)AdventureWorks.Dal.EntityType.ProductProductPhotoEntity, (int)AdventureWorks.Dal.EntityType.ProductEntity, 0, null, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductPhotoEntityFactory))),	(IEntityRelation)GetRelationsForField("ProductPhoto")[0], (int)AdventureWorks.Dal.EntityType.ProductProductPhotoEntity, (int)AdventureWorks.Dal.EntityType.ProductPhotoEntity, 0, null, null, null, null, "ProductPhoto", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.ProductProductPhotoEntity; }
		}
