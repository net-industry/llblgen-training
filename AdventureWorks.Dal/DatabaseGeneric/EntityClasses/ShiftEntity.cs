...
namespace AdventureWorks.Dal.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				case "EmployeeDepartmentHistories":
					...
					break;
				case "DepartmentCollectionViaEmployeeDepartmentHistory":
					toReturn.Add(Relations.EmployeeDepartmentHistoryEntityUsingShiftId, "ShiftEntity__", "EmployeeDepartmentHistory_", JoinHint.None);
		...
		public virtual IRelationPredicateBucket GetRelationInfoDepartmentCollectionViaEmployeeDepartmentHistory()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ShiftFields.ShiftId, null, ComparisonOperator.Equal, this.ShiftId, "ShiftEntity__"));
			return bucket;
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<EmployeeDepartmentHistoryEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeDepartmentHistoryEntityFactory))), (IEntityRelation)GetRelationsForField("EmployeeDepartmentHistories")[0], (int)AdventureWorks.Dal.EntityType.ShiftEntity, (int)AdventureWorks.Dal.EntityType.EmployeeDepartmentHistoryEntity, 0, null, null, null, null, "EmployeeDepartmentHistories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathDepartmentCollectionViaEmployeeDepartmentHistory
		{
			get
			{
				IEntityRelation intermediateRelation = Relations.EmployeeDepartmentHistoryEntityUsingShiftId;
				...
				return new PrefetchPathElement2(new EntityCollection<DepartmentEntity>(EntityFactoryCache2.GetEntityFactory(typeof(DepartmentEntityFactory))), intermediateRelation,
					(int)AdventureWorks.Dal.EntityType.ShiftEntity, (int)AdventureWorks.Dal.EntityType.DepartmentEntity, 0, null, null, GetRelationsForField("DepartmentCollectionViaEmployeeDepartmentHistory"), null, "DepartmentCollectionViaEmployeeDepartmentHistory", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathEmployeeCollectionViaEmployeeDepartmentHistory
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<EmployeeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))), intermediateRelation,
					(int)AdventureWorks.Dal.EntityType.ShiftEntity, (int)AdventureWorks.Dal.EntityType.EmployeeEntity, 0, null, null, GetRelationsForField("EmployeeCollectionViaEmployeeDepartmentHistory"), null, "EmployeeCollectionViaEmployeeDepartmentHistory", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get { return GetOrCreateEntityCollection<DepartmentEntity, DepartmentEntityFactory>("ShiftCollectionViaEmployeeDepartmentHistory", false, true, ref _departmentCollectionViaEmployeeDepartmentHistory);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<EmployeeEntity, EmployeeEntityFactory>("ShiftCollectionViaEmployeeDepartmentHistory", false, true, ref _employeeCollectionViaEmployeeDepartmentHistory);	}
		}
		...
		{ 
			get { return (int)AdventureWorks.Dal.EntityType.ShiftEntity; }
		}
