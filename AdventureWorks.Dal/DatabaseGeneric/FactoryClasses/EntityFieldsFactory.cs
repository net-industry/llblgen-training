...
namespace AdventureWorks.Dal.FactoryClasses
{
	...
	{
		private static readonly Dictionary<AdventureWorks.Dal.EntityType, string> _entityTypeNamesCache = new Dictionary<AdventureWorks.Dal.EntityType, string>();

		/// <summary>static ctor which initializes the static entity type cache.</summary>
		static EntityFieldsFactory()
		{
			foreach(AdventureWorks.Dal.EntityType value in Enum.GetValues(typeof(AdventureWorks.Dal.EntityType)))
			{
				_entityTypeNamesCache.Add(value, Enum.GetName(typeof(AdventureWorks.Dal.EntityType), value));
			}
		}	
		...
		public static IEntityFields2 CreateEntityFieldsObject(AdventureWorks.Dal.EntityType relatedEntityType)
		{
