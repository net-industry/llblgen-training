...
namespace AdventureWorks.Dal.HelperClasses
{
	...
	internal class FieldInfoProviderCore : FieldInfoProviderBase
	{
		...
		private void InitEmployeeEntityInfos()
		{
			...
			this.AddElementFieldInfo("EmployeeEntity", "JobTitle", typeof(System.String), false, false, false, false,  (int)EmployeeFieldIndex.JobTitle, 50, 0, 0);
		...
		private void InitEmployeeDepartmentHistoryEntityInfos()
		{
			...
			this.AddElementFieldInfo("EmployeeDepartmentHistoryEntity", "BusinessEntityId", typeof(System.Int32), true, true, false, false,  (int)EmployeeDepartmentHistoryFieldIndex.BusinessEntityId, 0, 0, 10);
		...
		private void InitEmployeePayHistoryEntityInfos()
		{
			...
			this.AddElementFieldInfo("EmployeePayHistoryEntity", "BusinessEntityId", typeof(System.Int32), true, true, false, false,  (int)EmployeePayHistoryFieldIndex.BusinessEntityId, 0, 0, 10);
		...
		private void InitJobCandidateEntityInfos()
		{
			...
			this.AddElementFieldInfo("JobCandidateEntity", "BusinessEntityId", typeof(Nullable<System.Int32>), false, true, false, true,  (int)JobCandidateFieldIndex.BusinessEntityId, 0, 0, 10);
		...
		private void InitProductVendorEntityInfos()
		{
			...
			this.AddElementFieldInfo("ProductVendorEntity", "BusinessEntityId", typeof(System.Int32), true, true, false, false,  (int)ProductVendorFieldIndex.BusinessEntityId, 0, 0, 10);
		...
		private void InitSalesPersonEntityInfos()
		{
			...
			this.AddElementFieldInfo("SalesPersonEntity", "BusinessEntityId", typeof(System.Int32), true, true, false, false,  (int)SalesPersonFieldIndex.BusinessEntityId, 0, 0, 10);
		...
		private void InitSalesPersonQuotaHistoryEntityInfos()
		{
			...
			this.AddElementFieldInfo("SalesPersonQuotaHistoryEntity", "BusinessEntityId", typeof(System.Int32), true, true, false, false,  (int)SalesPersonQuotaHistoryFieldIndex.BusinessEntityId, 0, 0, 10);
		...
		private void InitSalesTerritoryHistoryEntityInfos()
		{
			...
			this.AddElementFieldInfo("SalesTerritoryHistoryEntity", "BusinessEntityId", typeof(System.Int32), true, true, false, false,  (int)SalesTerritoryHistoryFieldIndex.BusinessEntityId, 0, 0, 10);
