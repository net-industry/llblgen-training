...
namespace AdventureWorks.Web.Tests._01_Predicates
{
    ...
    public class TransactionsTests : BaseUnitTest
    {
        ...
        public void UpdateEmployeeWithTransaction()
        {
            ...
            try
            {
                EmployeeEntity employeeEntity = this.metaData.Employee.Single(e => e.EmployeeId == 1);
                adapter.SaveEntity(employeeEntity);
                
                ContactEntity contactEntity = this.metaData.Contact.Single(c => c.Employees.Any(e => e.EmployeeId == 1));
